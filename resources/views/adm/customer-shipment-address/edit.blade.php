            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{ url(ENV('ADMIN_FOLDER_NAME') . '/' . $folder . '/' . $customer_shipping->id) }}"
                                ...
                                <div class="input-group mb-3" style="margin-top: 15px;">
                                    ...
                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror"
                                        ...
                                        @php
                                            $customerId = $customer_shipping->customer_id;
                                        @endphp
                                        @if (old('customer_id'))
                                            @php
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="address" name="address" maxlength="1024" class="form-control @error('address') is-invalid @enderror"
                                        rows="3" aria-label="address">
@if (old('address'))
{{ old('address') }}@else{{ $customer_shipping->address }}
@endif
</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="input-group mb-3" style="margin-top: 15px;">
                                    ...
                                    <select class="form-select single-select @error('province_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $provinceId = $customer_shipping->province_id;
                                        @endphp
                                        @if (old('province_id'))
                                            @php
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select single-select @error('city_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $cityId = $customer_shipping->city_id;
                                        @endphp
                                        @if (old('city_id'))
                                            @php
                                                $cityId = old('city_id');
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select single-select @error('district_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $districtId = $customer_shipping->district_id;
                                        @endphp
                                        @if (old('district_id'))
                                            @php
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $subdistrictId = $customer_shipping->sub_district_id;
                                        @endphp
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="phone" name="phone"
                                        ...
                                        value="@if (old('phone')) {{ old('phone') }}@else{{ $customer_shipping->phone }} @endif">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="input-group mb-3" style="margin-top: 15px;">
                                    ...
                                    <div class="input-group-text">
                                        @php
                                            $active = $customer_shipping->active;
                                        @endphp
                                        @if (old('active') == 'on')
                                            @php
                                                $active = 'Y';
