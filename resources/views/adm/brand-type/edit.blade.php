        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    ...
                    <hr />
                    <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/'.$uri.'/'.$brandtypes->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('brand_id') is-invalid @enderror"
                                            ...
                                            @php
                                                $p_Id = (old('brand_id')?old('brand_id'):$brandtypes->brand_id);
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="brand_type_name" name="brand_type_name" class="form-control @error('brand_type_name') is-invalid @enderror" maxlength="512"
                                            aria-label="Title (Ind)" value="@if(old('brand_type_name')){{ old('brand_type_name') }}@else{{ $brandtypes->brand_type }}@endif">
