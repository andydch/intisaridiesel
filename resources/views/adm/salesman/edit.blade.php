    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url(ENV('ADMIN_FOLDER_NAME') . '/salesman/' . $salesman->id) }}" method="POST"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="salesmanName" name="salesmanName"
                                    ...
                                    value="@if (old('salesmanName')) {{ old('salesmanName') }}@else{{ $salesman->name }} @endif">
                                @error('salesmanName')
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="address" name="address" maxlength="1024"
                                    ...
                                    aria-label="address">@if (old('address')){{ old('address') }}@else{{ $salesman->address }}@endif</textarea>
                                @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3" style="margin-top: 15px;">
                                ...
                                <select class="form-select single-select @error('province_id') is-invalid @enderror"
                                    ...
                                    <option value="#">Choose...</option>
                                    @php
                                    $provinceId = $salesman->province_id;
                                    @endphp
                                    @if (old('province_id'))
                                    @php
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select single-select @error('district_id') is-invalid @enderror"
                                    ...
                                    <option value="#">Choose...</option>
                                    @php
                                    $districtId = $salesman->district_id;
                                    @endphp
                                    @if (old('district_id'))
                                    @php
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror"
                                    ...
                                    <option value="#">Choose...</option>
                                    @php
                                    $subdistrictId = $salesman->sub_district_id;
                                    @endphp
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="postcode" name="postcode"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('postcode')) {{ old('postcode') }}@else{{ $salesman->post_code }} @endif">
                                @error('postcode')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="idNo" name="idNo"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('idNo')) {{ old('idNo') }}@else{{ $salesman->id_no }} @endif">
                                @error('idNo')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="email" id="sales_email" name="sales_email"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('sales_email')) {{ old('sales_email') }}@else{{ $salesman->email }} @endif">
                                @error('sales_email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="phone1" name="phone1"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('phone1')) {{ old('phone1') }}@else{{ $salesman->mobilephone }} @endif">
                                @error('phone1')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('birth_date') is-invalid @enderror"
                                    ...
                                    value="@if (old('birth_date')){{ old('birth_date') }}@else{{ $salesman->birth_date }}@endif">
                                @error('birth_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('join_date') is-invalid @enderror"
                                    ...
                                    value="@if (old('join_date')){{ old('join_date') }}@else{{ $salesman->join_date }}@endif">
                                @error('join_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="sales_target" name="sales_target"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('sales_target')){{ old('sales_target') }}@else{{ number_format($salesman->sales_target,2,',','.') }}@endif">
                                @error('sales_target')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
