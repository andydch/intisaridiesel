                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="initial" name="initial" class="form-control @error('initial') is-invalid @enderror" maxlength="12"
                                            value="@if (old('initial')){{ old('initial') }}@else{{ $branch->initial }}@endif">
                                        @error('initial')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="branchName" name="branchName" class="form-control @error('branchName') is-invalid @enderror"
                                            maxlength="255" value="@if (old('branchName')){{ old('branchName') }}@else{{ $branch->name }}@endif">
                                        @error('branchName')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="address" name="address" maxlength="1024" class="form-control @error('address') is-invalid @enderror"
                                            rows="3" aria-label="address">@if (old('address')){{ old('address') }}@else{{ $branch->address }}@endif</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('province_id') is-invalid @enderror" id="province_id" name="province_id">
                                            ...
                                            @php
                                                $provinceId = old('province_id')?old('province_id'):$branch->province_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('city_id') is-invalid @enderror" id="city_id" name="city_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $cityId = old('city_id')?old('city_id'):$branch->city_id;
                                            @endphp
                                            @foreach ($cities as $c)
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('district_id') is-invalid @enderror" id="district_id" name="district_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $districtId = old('district_id')?old('district_id'):$branch->district_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror" id="subdistrict_id" name="subdistrict_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $subdistrictId = old('subdistrict_id')?old('subdistrict_id'):$branch->sub_district_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="postcode" name="postcode" class="form-control @error('postcode') is-invalid @enderror"
                                            maxlength="6" value="@if(old('postcode')){{ old('postcode') }}@else{{ $branch->post_code }}@endif">
                                        @error('postcode')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="phone1" name="phone1" class="form-control @error('phone1') is-invalid @enderror"
                                            maxlength="32" value="@if(old('phone1')){{ old('phone1') }}@else{{ $branch->phone1 }}@endif">
                                        @error('phone1')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="phone2" name="phone2" class="form-control @error('phone2') is-invalid @enderror"
                                            maxlength="32" value="@if(old('phone2')){{ old('phone2') }}@else{{ $branch->phone2 }}@endif">
                                        @error('phone2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
