                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('supplierType_id') is-invalid @enderror" id="supplierType_id" name="supplierType_id">
                                        ...
                                        @php
                                            $supplierTypeId = old('supplierType_id')?old('supplierType_id'):11;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="supplierName" name="supplierName" class="form-control @error('supplierName') is-invalid @enderror"
                                        maxlength="255" value="@if (old('supplierName')){{ old('supplierName') }}@endif">
                                    @error('supplierName')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="supplierCode" name="supplierCode" class="form-control @error('supplierCode') is-invalid @enderror"
                                        maxlength="5" value="@if (old('supplierCode')){{ old('supplierCode') }}@endif">
                                    @error('supplierCode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div id="supplier_code_warn"></div>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('country_id') is-invalid @enderror" id="country_id" name="country_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $countryId = old('country_id')?old('country_id'):9999;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="supplier_email" name="supplier_email" class="form-control @error('supplier_email') is-invalid @enderror"
                                        maxlength="64" value="@if (old('supplier_email')){{ old('supplier_email') }}@endif">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="pic1Name" name="pic1Name" class="form-control @error('pic1Name') is-invalid @enderror"
                                        maxlength="255" value="@if(old('pic1Name')){{ old('pic1Name') }}@endif">
                                    @error('pic1Name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="picphone1" name="picphone1" class="form-control @error('picphone1') is-invalid @enderror"
                                        maxlength="32" value="@if(old('picphone1')){{ old('picphone1') }}@endif">
                                    @error('picphone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="pic_email1" name="pic_email1" class="form-control @error('pic_email1') is-invalid @enderror"
                                        maxlength="64" value="@if(old('pic_email1')){{ old('pic_email1') }}@endif">
                                    @error('pic_email1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="pic2Name" name="pic2Name" class="form-control @error('pic2Name') is-invalid @enderror"
                                        maxlength="255" value="@if(old('pic2Name')){{ old('pic2Name') }}@endif">
                                    @error('pic2Name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="picphone2" name="picphone2" class="form-control @error('picphone2') is-invalid @enderror"
                                        maxlength="32" value="@if(old('picphone2')){{ old('picphone2') }}@endif">
                                    @error('picphone2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="pic_email2" name="pic_email2" class="form-control @error('pic_email2') is-invalid @enderror"
                                        maxlength="64" value="@if(old('pic_email2')){{ old('pic_email2') }}@endif">
                                    @error('pic_email2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="npwp_no" name="npwp_no" class="form-control @error('npwp_no') is-invalid @enderror"
                                        maxlength="24" value="@if(old('npwp_no')){{ old('npwp_no') }}@endif">
                                    @error('npwp_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            {{-- <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('payment_from_id') is-invalid @enderror" id="payment_from_id" name="payment_from_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $payment_from_id = old('payment_from_id')?old('payment_from_id'):0;
                                        @endphp
                                        @foreach ($coas as $coa)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="beginning_balance" name="beginning_balance" onkeyup="formatAmount($(this));"
                                        ...
                                        value="@if(old('beginning_balance')){{ old('beginning_balance') }}@endif">
                                    @error('credit_limit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#supplierCode').change(function() {
            ...
            $('#msg-modal-info').html('&nbsp;');
            var fd = new FormData();
            fd.append('supplierCode', $('#supplierCode').val());
            $.ajax({
                url: '{{ url("disp_similar_suppliercode") }}',
                type: "POST",
                enctype: "application/x-www-form-urlencoded",
                data: fd,
                cache: false,
                ...
                success: function (res) {
                    ...
                    if (totSuppliers > 0) {
                        ...
                        $("#supplier_code_warn").addClass("invalid-feedback");
                        $("#supplier_code_warn").text('Supplier Code already Exist.');
                        $("#supplierName").focus();
                        $("#supplier_code_warn").focus();
                        ...
                        $('#msg-warn').text('Supplier Code already Exist.');
                        $('#msg-modal').html(vHtml);
                        $('#supplier-info').modal('show');

                        for (let i = 0; i < totSuppliers; i++) {
                            let supplier_code = o[i].supplier_code;
                            if($('#supplierCode').val()===supplier_code){
                                $("#save").attr("disabled","disabled");
                                break;
                            }
                        }
                        ...
                        $("#supplier_code_warn").removeClass("invalid-feedback");
                        $("#supplier_code_warn").text('');
                        $("#supplier_code_warn").focus();
                    }
                },
            });
