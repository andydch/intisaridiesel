                                    ...
                                    @foreach ($globals as $g)
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" name="currency_id{{ $i }}" id="currency_id{{ $i }}" value="{{ $g->id }}">
                                            </td>
                                            <td>{{ $g->string_val }}</td>
                                            <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btn-del-row").click(function() {
                ...
                if(rowNo!=''){
                    let msg = 'The following Currencies will be deleted.\n'+rowNo+'\nProcess cannot be undone. Continue?';
                    if(!confirm(msg)){
