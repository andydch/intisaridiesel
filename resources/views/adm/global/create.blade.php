        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url(ENV('ADMIN_FOLDER_NAME') . '/mst-global') }}" method="POST"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="dataCategory" name="dataCategory"
                                        ...
                                        value="@if (old('dataCategory')) {{ old('dataCategory') }} @endif">
                                    @error('dataCategory')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="title_eng" name="title_eng"
                                        ...
                                        value="@if (old('title_eng')) {{ old('title_eng') }} @endif">
                                    @error('title_eng')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
