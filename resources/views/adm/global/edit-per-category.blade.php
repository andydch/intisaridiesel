        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url(ENV('ADMIN_FOLDER_NAME') . '/' . $uri . '/' . $globals->id) }}" method="POST"
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="notes" name="notes" maxlength="1000" class="form-control @error('notes') is-invalid @enderror"
                                        rows="3" aria-label="Notes">@if (old('notes')){{ old('notes') }}@else{{ $globals->notes }}@endif</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="input-group" style="margin-top: 15px;">
                                    ...
                                    <textarea id="small_desc_ind" name="small_desc_ind" maxlength="1000"
                                        ...
                                        aria-label="Small Description (Ind)">@if (old('small_desc_ind')){{ old('small_desc_ind') }}@else{{ $globals->small_desc_ind }}@endif</textarea>
                                ...
                                <div class="input-group" style="margin-top: 15px;">
                                    ...
                                    <textarea id="long_desc_ind" name="long_desc_ind" maxlength="8000"
                                        ...
                                        aria-label="Long Description (Ind)">@if (old('long_desc_ind')){{ old('long_desc_ind') }}@else{{ $globals->long_desc_ind }}@endif</textarea>
                                    @error('long_desc_ind')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                @else
                                    <input type="hidden" name="value_string" id="value_string" value="{{ $globals->string_val }}">
                                @endif
                                @if($uri=='vat')
                                    <div class="input-group mb-3" style="margin-top: 15px;">
                                ...
                                @else
                                    <input type="hidden" name="value_numeric" id="value_numeric" value="{{ $globals->numeric_val }}">
                                @endif
                                <div class="input-group mb-3" style="margin-top: 15px;">
                                    @php
