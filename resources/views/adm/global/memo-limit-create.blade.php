                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input onkeyup="formatPartPrice($(this));" type="text" id="memo_limit_val" name="memo_limit_val" class="form-control @error('memo_limit_val') is-invalid @enderror"
                                        maxlength="25" aria-label="memo limit" value="@if(old('memo_limit_val')){{ old('memo_limit_val') }}@endif">
