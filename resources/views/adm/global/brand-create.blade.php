                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        aria-label="Title (Ind)" value="@if(old('title_ind')){{ old('title_ind') }}@endif">
                                        @error('title_ind')
                                ...
                                {{-- <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        aria-label="Title (Ind)" value="@if(old('value_string')){{ old('value_string') }}@endif">
                                        @error('value_string')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
<script>
    $(document).ready(function() {
        $("#title_ind").keyup(function() {
            let title_ind = $("#title_ind").val();
            $("#title_ind").val(title_ind.toUpperCase());
        });
        $("#save").click(function() {
