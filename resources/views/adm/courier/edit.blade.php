...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <div class="row">
            <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/'.$folder.'/'.urlencode($courier->slug)) }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                @method('PUT')
                ...
                <div class="col-xl-12 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('entityType_id') is-invalid @enderror" id="entityType_id" name="entityType_id">
                                        ...
                                        @php
                                            $entityTypeId = old('entityType_id')?old('entityType_id'):$courier->entity_type_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="courierName" name="courierName"
                                        ...
                                        value="@if (old('courierName')){{ old('courierName') }}@else{{ $courier->name }}@endif">
                                    @error('courierName')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="office_address" name="office_address" maxlength="1024"
                                        ...
                                        rows="3">@if (old('office_address')){{ old('office_address') }}@else{{ $courier->office_address }}@endif</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('province_id') is-invalid @enderror" id="province_id" name="province_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $provinceId = old('province_id')?old('province_id'):$courier->province_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('city_id') is-invalid @enderror" id="city_id" name="city_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $cityId = old('city_id')?old('city_id'):$courier->city_id;
                                        @endphp
                                        @foreach ($cities as $c)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('district_id') is-invalid @enderror" id="district_id" name="district_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $districtId = old('district_id')?old('district_id'):$courier->district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror" id="subdistrict_id" name="subdistrict_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $subdistrictId = old('subdistrict_id')?old('subdistrict_id'):$courier->sub_district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="postcode" name="postcode"
                                        ...
                                        value="@if (old('postcode')){{ old('postcode') }}@else{{ $courier->post_code }}@endif">
                                    @error('postcode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="courier_email" name="courier_email"
                                        ...
                                        value="@if (old('courier_email')){{ old('courier_email') }}@else{{ $courier->courier_email }}@endif">
                                    @error('courier_email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="phone1" name="phone1"
                                        ...
                                        value="@if (old('phone1')){{ old('phone1') }}@else{{ $courier->phone1 }}@endif">
                                    @error('phone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="phone2" name="phone2"
                                        ...
                                        value="@if (old('phone2')){{ old('phone2') }}@else{{ $courier->phone2 }}@endif">
                                    @error('phone2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="pic1Name" name="pic1Name"
                                        ...
                                        value="@if (old('pic1Name')){{ old('pic1Name') }}@else{{ $courier->pic1_name }}@endif">
                                    @error('pic1Name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="picphone1" name="picphone1"
                                        ...
                                        value="@if (old('picphone1')){{ old('picphone1') }}@else{{ $courier->pic1_phone }}@endif">
                                    @error('picphone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="pic_email1" name="pic_email1"
                                        ...
                                        value="@if (old('pic_email1')){{ old('pic_email1') }}@else{{ $courier->pic1_email }}@endif">
                                    @error('pic_email1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="npwp_no" name="npwp_no"
                                        ...
                                        value="@if (old('npwp_no')){{ old('npwp_no') }}@else{{ $courier->npwp_no }}@endif">
                                    @error('npwp_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            @php
                                $disabled = '';
                                $npwp_address = old('npwp_address')?old('npwp_address'):$courier->npwp_address;
                                $npwp_province_id = old('npwp_province_id')?old('npwp_province_id'):$courier->npwp_province_id;
                                $npwp_city_id = old('npwp_city_id')?old('npwp_city_id'):$courier->npwp_city_id;
                                $npwp_district_id = old('npwp_district_id')?old('npwp_district_id'):$courier->npwp_district_id;
                                $npwp_subdistrict_id = old('npwp_subdistrict_id')?old('npwp_subdistrict_id'):$courier->npwp_sub_district_id;
                            @endphp
                                    ...
                                    @else
                                        ...
                                        @foreach ($queryBank as $qB)
                                            <tr id="row{{ $i }}">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control @error('bank_name'.$i) is-invalid @enderror"
                                                        id="bank_name{{ $i }}" name="bank_name{{ $i }}" maxlength="255" value="{{ $qB->bank_name }}" />
                                                    @error('bank_name'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <textarea id="bank_address{{ $i }}" name="bank_address{{ $i }}" maxlength="1024"
                                                        class="form-control @error('bank_address'.$i) is-invalid @enderror" rows="3">{{ $qB->bank_address }}</textarea>
                                                    @error('bank_address'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control @error('account_name'.$i) is-invalid @enderror"
                                                        id="account_name{{ $i }}" name="account_name{{ $i }}" maxlength="255" value="{{ $qB->account_name }}" />
                                                    @error('account_name'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control @error('account_no'.$i) is-invalid @enderror"
                                                        id="account_no{{ $i }}" name="account_no{{ $i }}" maxlength="255" value="{{ $qB->account_no }}" />
                                                    @error('account_no'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control @error('swift_code'.$i) is-invalid @enderror"
                                                        id="swift_code{{ $i }}" name="swift_code{{ $i }}" maxlength="255" value="{{ $qB->swift_code }}" />
                                                    @error('swift_code'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control @error('bsb_code'.$i) is-invalid @enderror"
                                                        id="bsb_code{{ $i }}" name="bsb_code{{ $i }}" maxlength="255" value="{{ $qB->bsb_code }}" />
                                                    @error('bsb_code'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btn-add-row").click(function() {
            ...
            '<tr id="row' + totalRow + '">' +
                '<th scope="row">'+
                '<span class="col-form-label">' + rowNo + '.</span>'+
                '<input type="hidden" name="bank_id_'+totalRow+'" id="bank_id_'+totalRow+'" value="0" />'+
                '</th>' +
                '<td>'+
