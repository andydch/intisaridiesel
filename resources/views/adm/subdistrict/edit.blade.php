                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('country_id') is-invalid @enderror" id="country_id" name="country_id">
                                            ...
                                            @php
                                                $countryId = old('country_id')?old('country_id'):$subdistrict->district->city->country->id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('province_id') is-invalid @enderror"
                                            ...
                                            <option value="#">Choose...</option>
                                            @php
                                                $provinceId = old('province_id')?old('province_id'):$subdistrict->district->city->province->id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('city_id') is-invalid @enderror"
                                            ...
                                            <option value="#">Choose...</option>
                                            @php
                                                $cityId = old('city_id')?old('city_id'):$subdistrict->district->city->id;
                                            @endphp
                                            @foreach ($city as $c)
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('district_id') is-invalid @enderror" id="district_id" name="district_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $districtId = old('district_id')?old('district_id'):$subdistrict->district_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="subdistrictName" name="subdistrictName"
                                            ...
                                            value="@if (old('subdistrictName')){{ old('subdistrictName') }}@else{{ $subdistrict->sub_district_name }}@endif">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="postcode" name="postcode"
                                            ...
                                            value="@if (old('postcode')){{ old('postcode') }}@else{{ $subdistrict->post_code }}@endif">
                                        @error('postcode')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    success: function(res) {
                        ...
                        if (totProvince > 0) {
                            for (let i = 0; i < totProvince; i++) {
                                ...
                                optionValue = o[i].id;
                                $("#province_id").append(`<option value="${optionValue}">${optionText}</option>`);
                            }
                        }
                    },
                });
                    ...
                    success: function(res) {
                        ...
                        if (totCity > 0) {
                            for (let i = 0; i < totCity; i++) {
                                ...
                                optionValue = o[i].id;
                                $("#city_id").append(`<option value="${optionValue}">${optionText}</option>`);
                            }
                        }
                    },
                });
                    ...
                    success: function(res) {
                        ...
                        if (totDistrict > 0) {
                            for (let i = 0; i < totDistrict; i++) {
                                ...
                                optionValue = o[i].id;
                                $("#district_id").append(`<option value="${optionValue}">${optionText}</option>`);
                            }
                        }
                    },
                });
