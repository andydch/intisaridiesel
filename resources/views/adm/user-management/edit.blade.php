							...
							<div class="card-body">
								...
								<div class="tab-content py-3">
									<div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="initial" name="initial" class="form-control @error('initial') is-invalid @enderror"
                                                    maxlength="3" value="@if (old('initial')){{ old('initial') }}@else{{ $userdetail->initial }}@endif">
                                                @error('initial')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input readonly type="text" class="form-control @error('date_of_birth') is-invalid @enderror"
                                                    maxlength="12" id="date_of_birth" name="date_of_birth" placeholder="Date of Birth"
                                        ...
                                        <div class="row mb-3">
                                            <input type="hidden" name="signage_pic_tmp" id="signage_pic_tmp" value="{{ $userdetail->signage_pic }}">
                                        ...
                                        <div class="row mb-3">
                                            <span class="col-sm-3 col-form-label">&nbsp;</span>
                                            <div class="col-sm-9">
                                                @if (!is_null($userdetail->signage_pic))
									...
									<div class="tab-pane fade" id="primaryprofile" role="tabpanel">
										<div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" id="uname" name="uname" class="form-control @error('uname') is-invalid @enderror"
                                                    maxlength="255" placeholder="Your email" value="@if (old('uname')){{ old('uname') }}@else{{ $user->email }}@endif">
                                                @error('uname')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="password" id="pwd" name="pwd" class="form-control @error('pwd') is-invalid @enderror"
                                                    maxlength="255" placeholder="Your password" value="@if (old('pwd')){{ old('pwd') }}@else{{ '' }}@endif">
                                                @error('pwd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="password" id="c_pwd" name="c_pwd" class="form-control @error('c_pwd') is-invalid @enderror"
                                                    maxlength="255" placeholder="Confirm your password" value="@if (old('c_pwd')){{ old('c_pwd') }}@else{{ '' }}@endif">
                                                @error('c_pwd')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select single-select @error('section_id') is-invalid @enderror"
                                                    ...
                                                    @php
                                                        $section_id = old('section_id')?old('section_id'):$userdetail->section_id;
                                                    @endphp
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if (old('is_salesman'))
                                                    @php
                                                        $isSalesman = (old('is_salesman')=='on'?'checked':'');
                                                    @endphp
                                                @else
                                                    @if ($userdetail->is_salesman=='Y')
                                                        @php
                                                            $isSalesman = 'checked';
                                                        @endphp
                                                    @endif
                                                @endif
                                                <input type="checkbox" name="is_salesman" id="is_salesman" {{ $isSalesman }}>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if (old('is_director'))
                                                    @php
                                                        $isDirector = (old('is_director')=='on'?'checked':'');
                                                    @endphp
                                                @else
                                                    @if ($userdetail->is_director=='Y')
                                                        @php
                                                            $isDirector = 'checked';
                                                        @endphp
                                                    @endif
                                                @endif
                                                <input type="checkbox" name="is_director" id="is_director" {{ $isDirector }}>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                @php
                                                    $isBranchHead = '';
                                                @endphp
                                                @if (old('is_branch_head'))
                                                    @php
                                                        $isBranchHead = (old('is_branch_head')=='on'?'checked':'');
                                                    @endphp
                                                @else
                                                    @if ($userdetail->is_branch_head=='Y')
                                                        @php
                                                            $isBranchHead = 'checked';
                                                        @endphp
                                                    @endif
                                                @endif
                                                <input type="checkbox" name="is_branch_head" id="is_branch_head" {{ $isBranchHead }}>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select single-select @error('branch_id') is-invalid @enderror"
                                                    ...
                                                    <option value="#">Choose...</option>
                                                    @php
                                                        $branch_id = old('branch_id')?old('branch_id'):$userdetail->branch_id;
                                                    @endphp
                                        ...
                                        <div class="row mb-3" style="padding: 0 15px 15px 15px;">
                                            ...
                                            @foreach ($menus as $q)
                                                ...
                                                <div class="col-sm-3 form-check">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="menuCheck{{ $inputCount }}" name="menuCheck{{ $inputCount }}" {{ $menuChecked }}>
