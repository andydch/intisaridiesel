    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url(ENV('ADMIN_FOLDER_NAME') . '/'.$folder.'/'.$parts->id) }}" method="POST"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="part_no" name="part_no"
                                    ...
                                    value="@if (old('part_no')){{ old('part_no') }}@else{{ substr($parts->part_number,0,5).'-'.substr($parts->part_number,5,strlen($parts->part_number)) }}@endif">
                                @error('part_no')
                            ...
                            <div class="input-group mb-3" style="margin-top: 15px;">
                                ...
                                <select class="form-select single-select @error('partCategory_id') is-invalid @enderror"
                                    ...
                                    <option value="#">Choose...</option>
                                    @php
                                    $partCategoryId = $parts->part_category_id;
                                    @endphp
                            ...
                            <div id="brand-type" class="input-group mb-3" style="margin-top: 15px">
                                ...
                                <div class="input-group-text">
                                    <input type="hidden" id="brand_type_count" name="brand_type_count"
                                        value="@if(old('brand_type_count')){{ old('brand_type_count') }}@else{{ $queryBrandTypecount }}@endif">
                                    <table>
                                        <tbody id="brand-type-item">
                                            ...
                                            @foreach ($queryBrandType as $q)
                                                ...
                                                @else
                                                @php
                                                $queryBrandType = \App\Models\Mst_part_brand_type::where([
                                                    'part_id' => $parts->id,
                            ...
                            <div class="input-group mb-3" style="margin-top: 15px;">
                                ...
                                <select class="form-select single-select @error('quantity_id') is-invalid @enderror"
                                    ...
                                    <option value="#">Choose...</option>
                                    @php
                                    $quantityId = $parts->quantity_type_id;
                                    @endphp
                                    @if (old('quantity_id'))
                                    @php
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="price_list" name="price_list"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('price_list')){{ old('price_list') }}@else{{ number_format($parts->price_list,2,',','.') }}@endif">
                                @error('price_list')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="final_price" name="final_price"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('final_price')){{ old('final_price') }}@else{{ number_format($parts->final_price,2,',','.') }}@endif">
                                @error('final_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="avg_cost" name="avg_cost"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('avg_cost')){{ old('avg_cost') }}@else{{ number_format($parts->avg_cost,2,',','.') }}@endif">
                                @error('avg_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="initial_cost" name="initial_cost"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('initial_cost')){{ old('initial_cost') }}@else{{ number_format($parts->initial_cost,2,',','.') }}@endif">
                                @error('initial_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="final_cost" name="final_cost"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('final_cost')){{ old('final_cost') }}@else{{ number_format($parts->final_cost,2,',','.') }}@endif">
                                @error('final_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="total_cost" name="total_cost"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('total_cost')){{ old('total_cost') }}@else{{ number_format($parts->total_cost,2,',','.') }}@endif">
                                @error('total_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                            {{-- <div class="input-group mb-3">
                                ...
                                <input type="text" id="total_sales" name="total_sales"
                                    ...
                                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                    value="@if (old('total_sales')) {{ old('total_sales') }}@else{{ number_format($parts->total_sales,2,',','.') }}@endif">
                                @error('total_sales')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> --}}
                                ...
                                <div class="input-group-text">
                                    <table>
                                        <tbody id="part-subtitution-item">
                                            <input type="hidden" name="part_count" id="part_count"
                                                value="{{ $queryOtherPartCount }}">
                                            @php
                                            $i = 0;
                                            $vHtml = '';
                                            @endphp
                                            ...
                                            @foreach ($queryOtherPart as $q)
                                                ...
                                                @else
                                                @php
                                                $querySubtitution = \App\Models\Mst_part_subtitution::where([
                                                    'part_id' => $parts->id,
                                                    'part_other_id' => $q->id,
                                                    'active' => 'Y'
                                                ])
                            ...
                            <div class="input-group mb-3" style="margin-top: 15px;">
                                ...
                                <div class="input-group-text">
                                    <input class="form-check-input" type="checkbox" id="active" name="active"
                                        aria-label="Active" @if ($active=='Y' ) {{ 'checked' }} @endif>
                                </div>
                            </div>
