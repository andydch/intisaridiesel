        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    ...
                    <hr />
                    <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/district') }}" method="POST" enctype="application/x-www-form-urlencoded">
                        @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="districtName" name="districtName" class="form-control @error('districtName') is-invalid @enderror" maxlength="128"
                                            aria-label="Title (Ind)" value="@if(old('districtName')){{ old('districtName') }}@endif">
                                        @error('districtName')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
