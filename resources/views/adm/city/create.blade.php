    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                ...
                <hr />
                <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/city') }}" method="POST" enctype="application/x-www-form-urlencoded">
                    @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="cityName" name="cityName" class="form-control @error('cityName') is-invalid @enderror" maxlength="128"
                                        aria-label="Title (Ind)" value="@if(old('cityName')){{ old('cityName') }}@endif">
                                    @error('cityName')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('city_type') is-invalid @enderror" id="city_type" name="city_type">
                                        <option value="#">Choose...</option>
                                        @php
                                            $city_type = old('city_type')?old('city_type'):0;
                                        @endphp
