...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <div class="row">
            <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/'.$folder.'/'.urlencode($cust->slug)) }}" method="POST" enctype="application/x-www-form-urlencoded">
                @csrf
                @method('PUT')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('entityType_id') is-invalid @enderror" id="entityType_id" name="entityType_id">
                                        ...
                                        @php
                                            $entityTypeId = old('entityType_id')?old('entityType_id'):$cust->entity_type_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="customerName" name="customerName" class="form-control @error('customerName') is-invalid @enderror"
                                        maxlength="255" value="@if(old('customerName')){{ old('customerName') }}@else{{ $cust->name }}@endif">
                                    @error('customerName')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input readonly type="text" id="cust_unique_code" name="cust_unique_code"
                                        class="form-control @error('cust_unique_code') is-invalid @enderror" maxlength="5"
                                        value="@if(old('cust_unique_code')){{ old('cust_unique_code') }}@else{{ $cust->customer_unique_code }}@endif">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="office_address" name="office_address" maxlength="1024"
                                        ...
                                        rows="3">@if(old('office_address')){{ old('office_address') }}@else{{ $cust->office_address }}@endif</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('province_id') is-invalid @enderror" id="province_id" name="province_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $provinceId = old('province_id')?old('province_id'):$cust->province_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('city_id') is-invalid @enderror" id="city_id" name="city_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $cityId = old('city_id')?old('city_id'):$cust->city_id;
                                        @endphp
                                        @foreach ($cities as $c)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('district_id') is-invalid @enderror" id="district_id" name="district_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $districtId = old('district_id')?old('district_id'):$cust->district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror" id="subdistrict_id" name="subdistrict_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $subdistrictId = old('subdistrict_id')?old('subdistrict_id'):$cust->sub_district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="postcode" name="postcode" class="form-control @error('postcode') is-invalid @enderror"
                                        maxlength="6" value="@if (old('postcode')){{ old('postcode') }}@else{{ $cust->post_code }}@endif">
                                    @error('postcode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="customer_email" name="customer_email" class="form-control @error('customer_email') is-invalid @enderror"
                                        maxlength="64" value="@if (old('customer_email')){{ old('customer_email') }}@else{{ $cust->cust_email }}@endif">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="phone1" name="phone1" class="form-control @error('phone1') is-invalid @enderror"
                                        maxlength="32" value="@if (old('phone1')){{ old('phone1') }}@else{{ $cust->phone1 }}@endif">
                                    @error('phone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="phone2" name="phone2" class="form-control @error('phone2') is-invalid @enderror"
                                        maxlength="32" value="@if (old('phone2')){{ old('phone2') }}@else{{ $cust->phone2 }}@endif">
                                    @error('phone2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="pic1Name" name="pic1Name"
                                        ...
                                        value="@if (old('pic1Name')){{ old('pic1Name') }}@else{{ $cust->pic1_name }}@endif">
                                    @error('pic1Name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="picphone1" name="picphone1"
                                        ...
                                        value="@if (old('picphone1')){{ old('picphone1') }}@else{{ $cust->pic1_phone }}@endif">
                                    @error('picphone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="pic_email1" name="pic_email1"
                                        ...
                                        value="@if (old('pic_email1')){{ old('pic_email1') }}@else{{ $cust->pic1_email }}@endif">
                                    @error('pic_email1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="pic2Name" name="pic2Name"
                                        ...
                                        value="@if (old('pic2Name')){{ old('pic2Name') }}@else{{ $cust->pic2_name }}@endif">
                                    @error('pic2Name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="picphone2" name="picphone2"
                                        ...
                                        value="@if (old('picphone2')){{ old('picphone2') }}@else{{ $cust->pic2_phone }}@endif">
                                    @error('picphone2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="pic_email2" name="pic_email2"
                                        ...
                                        value="@if (old('pic_email2')){{ old('pic_email2') }}@else{{ $cust->pic2_email }}@endif">
                                    @error('pic_email2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="npwp_no" name="npwp_no"
                                        ...
                                        value="@if (old('npwp_no')){{ old('npwp_no') }}@else{{ $cust->npwp_no }}@endif">
                                    @error('npwp_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            @php
                                $disabled = '';
                                $npwp_address = old('npwp_address')?old('npwp_address'):'';
                                $npwp_province_id = old('npwp_province_id')?old('npwp_province_id'):0;
                                $npwp_city_id = old('npwp_city_id')?old('npwp_city_id'):0;
                                $npwp_district_id = old('npwp_district_id')?old('npwp_district_id'):0;
                                $npwp_subdistrict_id = old('npwp_subdistrict_id')?old('npwp_subdistrict_id'):0;
                            @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea {{ $disabled }} id="npwp_address" name="npwp_address" maxlength="1024"
                                        ...
                                        rows="3">@if (old('npwp_address')){{ $npwp_address }}@else{{ $cust->npwp_address }}@endif</textarea>
                                    @error('npwp_address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select {{ $disabled }} class="form-select single-select @error('npwp_province_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $npwp_provinceId = old('npwp_province_id')?$npwp_province_id:$cust->npwp_province_id;
                                        @endphp
                                        @foreach ($province as $p)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select {{ $disabled }} class="form-select single-select @error('npwp_city_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $npwp_cityId = old('npwp_city_id')?$npwp_city_id:$cust->npwp_city_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select {{ $disabled }} class="form-select single-select @error('npwp_district_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $npwp_districtId = old('npwp_district_id')?$npwp_district_id:$cust->npwp_district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select {{ $disabled }} class="form-select single-select @error('npwp_subdistrict_id') is-invalid @enderror"
                                        ...
                                        <option value="#">Choose...</option>
                                        @php
                                            $npwp_subdistrictId = old('npwp_subdistrict_id')?$npwp_subdistrict_id:$cust->npwp_sub_district_id;
                                        @endphp
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <input type="text" id="credit_limit" name="credit_limit" onkeyup="formatAmount($(this));"
                                            ...
                                            value="@if (old('credit_limit')){{ old('credit_limit') }}@else{{ ($cust->credit_limit==0)?'':number_format($cust->credit_limit,0,'.',',') }}@endif">                                        
                                        @error('credit_limit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                @else
                                    <input type="hidden" name="credit_limit" id="credit_limit" value="{{ number_format($cust->credit_limit,0,'.',',') }}">
                            ...
                            {{-- <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="limit_balance" name="limit_balance"
                                        ...
                                        value="@if (old('limit_balance')){{ old('limit_balance') }}@else{{ $cust->limit_balance }}@endif">
                                    @error('limit_balance')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <input type="text" id="top_in_day" name="top_in_day"
                                            ...
                                            value="@if (old('top_in_day')){{ !is_null(old('top_in_day'))?old('top_in_day'):'' }}@else{{ $cust->top }}@endif">
                                        @error('top_in_day')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>                                    
                                @else
                                    <input type="hidden" name="top_in_day" id="top_in_day" value="{{ $cust->top }}">
                            ...
                            <div class="row mb-3">
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $branch_id = old('branch_id')?old('branch_id'):$cust->branch_id;
                                            @endphp
                                ...
                                @else
                                    <input type="hidden" name="branch_id" id="branch_id" value="{{ $cust->branch_id }}">
                                    <span class="col-sm-9 col-form-label">{{ (!is_null($cust->branch)?$cust->branch->name:'') }}</span>
                                @endif
                            </div>
                            <div class="row mb-3">
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('salesman_id') is-invalid @enderror" id="salesman_id" name="salesman_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $salesmanId = old('salesman_id')?old('salesman_id'):$cust->salesman_id;
                                            @endphp
                                ...
                                @else
                                    <input type="hidden" name="salesman_id" id="salesman_id" value="{{ $cust->salesman_id }}">
                                    <span class="col-sm-9 col-form-label">{{ $cust->salesman01?$cust->salesman01->user->name:'-' }}</span>
                                @endif
                            </div>
                            {{-- <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('salesman_id2') is-invalid @enderror" id="salesman_id2" name="salesman_id2">
                                        <option value="#">Choose...</option>
                                        @php
                                            $salesmanId2 = old('salesman_id2')?old('salesman_id2'):$cust->salesman_id2;
                                        @endphp
                                        @foreach ($salesman as $s)
                            ...
                            <div class="row mb-3">
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <select class="form-select @error('cust_status') is-invalid @enderror" id="cust_status" name="cust_status">
                                            @php
                                                $cust_status = old('cust_status')?old('cust_status'):$cust->customer_status;
                                            @endphp
                                ...
                                @else
                                    <input type="hidden" name="cust_status" id="cust_status" value="{{ $cust->customer_status }}">
                            ...
                            <div class="row mb-3">
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <select class="form-select @error('payment_status') is-invalid @enderror" id="payment_status" name="payment_status">
                                            @php
                                                $payment_status = old('payment_status')?old('payment_status'):$cust->payment_status;
                                            @endphp
                                ...
                                @else
                                    <input type="hidden" name="payment_status" id="payment_status" value="{{ $cust->payment_status }}">
                                ...
                                @if ($direksi || $kacab)
                                    <div class="col-sm-9">
                                        <input type="text" id="beginning_balance" name="beginning_balance" onkeyup="formatAmount($(this));"
                                            ...
                                            value="@if(old('beginning_balance')){{ !is_null(old('beginning_balance'))?old('beginning_balance'):'' }}@else{{ number_format($cust->beginning_balance,0,'.',',') }}@endif">
                                        @error('beginning_balance')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>                                    
                                @else
                                    <input type="hidden" name="beginning_balance" id="beginning_balance" value="{{ $cust->beginning_balance }}">
                                    <span class="col-sm-9 col-form-label">{{ number_format($cust->beginning_balance,0,'.',',') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr id="row{{ $i }}">
                                                ...
                                                <td>
                                                    ...
                                                    {{-- @if(old('same_as_officeaddress_shipment'.$i)=='on')
                                                        ...
                                                        @endphp
                                                    @endif --}}
                                                    <input type="hidden" name="shipmentId{{ $i }}" id="shipmentId{{ $i }}" value="@if (old('shipmentId'.$i)){{ old('shipmentId'.$i) }}@endif" />
                                                    ...
                                                    <textarea {{ $disabled }} id="address_addr{{ $i }}" name="address_addr{{ $i }}" maxlength="1024"
                                                        class="form-control @error('address_addr'.$i) is-invalid @enderror"
                                                ...
                                                <td>
                                                    <select {{ $disabled }} class="form-select single-select @error('sub_district_id_addr'.$i) is-invalid @enderror"
                                                        ...
                                                        @foreach ($qSubDistrict as $d)
                                                            <option @if ($subdistrictId==$d->id){{ 'selected' }}@endif value="{{ $d->id }}">{{ $d->sub_district_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control @error('phone_addr'.$i) is-invalid @enderror"
                                    ...
                                    @else
                                        ...
                                        @foreach ($queryShipment as $qS)
                                            <tr id="row{{ $i }}">
                                                <th scope="row">{{ $i+1 }}</th>
                                                <td>
                                                    <input type="hidden" name="shipmentId{{ $i }}" id="shipmentId{{ $i }}" value="{{ $qS->id }}" />
                                                    <input type="checkbox" id="same_as_officeaddress_shipment{{ $i }}" onclick="sameAsAddressShipment({{ $i }})"
                                                        name="same_as_officeaddress_shipment{{ $i }}"
                                                        @if(old('same_as_officeaddress_shipment'.$i)=='on' ){{ 'checked' }}@endif> same as office address?<br />
                                                    <textarea id="address_addr{{ $i }}" name="address_addr{{ $i }}" maxlength="1024"
                                                        class="form-control @error('address_addr'.$i) is-invalid @enderror" rows="3">{{ $qS->address }}</textarea>
                                                    @error('address_addr'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <select class="form-select single-select @error('province_id_addr'.$i) is-invalid @enderror"
                                                        id="province_id_addr{{ $i }}" name="province_id_addr{{ $i }}" onchange="prepCity(this.value, {{ $i }});">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $provinceId = $qS->province_id;
                                                        @endphp
                                                        @foreach ($province as $p)
                                                            <option @if ($provinceId==$p->id){{ 'selected' }}@endif value="{{ $p->id }}">{{ $p->province_name }}</option>
                                                        @endforeach
                                                ...
                                                <td>
                                                    <select class="form-select single-select @error('city_id_addr'.$i) is-invalid @enderror"
                                                        id="city_id_addr{{ $i }}" name="city_id_addr{{ $i }}" onchange="prepDistrict(this.value,{{ $i }});">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $cityId = $qS->city_id;
                                                            $qCity = \App\Models\Mst_city::where('province_id','=',$qS->province_id)
                                                            ->where('active','=','Y')
                                                            ->get();
                                                        @endphp
                                                        @foreach ($qCity as $c)
                                                ...
                                                <td>
                                                    <select class="form-select single-select @error('district_id_addr'.$i) is-invalid @enderror"
                                                        id="district_id_addr{{ $i }}" name="district_id_addr{{ $i }}" onchange="prepSubDistrict(this.value,{{ $i }})">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $districtId = $qS->district_id;
                                                            $qDistrict = \App\Models\Mst_district::where('city_id','=',$qS->city_id)
                                                            ->where('active','=','Y')
                                                            ->get();
                                                        @endphp
                                                        @foreach ($qDistrict as $d)
                                                ...
                                                <td>
                                                    <select class="form-select single-select @error('sub_district_id_addr'.$i) is-invalid @enderror"
                                                        id="sub_district_id_addr{{ $i }}" name="sub_district_id_addr{{ $i  }}" onchange="prepPostCode(this.value,{{ $i }})">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $subdistrictId = $qS->sub_district_id;
                                                            $qSubDistrict = \App\Models\Mst_sub_district::where('district_id','=',$qS->district_id)
                                                            ->where('active','=','Y')
                                                            ->get();
                                                        @endphp
                                                        @foreach ($qSubDistrict as $d)
                                                            <option @if ($subdistrictId==$d->id){{ 'selected' }}@endif value="{{ $d->id }}">
                                                                {{ ucwords(strtolower($d->sub_district_name)) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('sub_district_id_addr'.$i)
                                                ...
                                                <td>
                                                    <input type="text" class="form-control @error('post_code_shipment'.$i) is-invalid @enderror"
                                                        id="post_code_shipment{{ $i }}" name="post_code_shipment{{ $i }}" maxlength="6" value="{{ $qS->post_code }}" />
                                                    @error('post_code_shipment'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control @error('phone_addr'.$i) is-invalid @enderror"
                                                        id="phone_addr{{ $i }}" name="phone_addr{{ $i }}" maxlength="32" value="{{ $qS->phone }}" />
                                                    @error('phone_addr'.$i)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            ...
            <div class="modal-body" style="color: #fff;">
                The following are similar customer names:<br />
    ...
    $(document).ready(function() {
        ...
        $("#btn-add-row").click(function() {
            ...
            let vHtml =
                ...
                '<td>'+
                '<input type="hidden" name="shipmentId'+totalRow+'" id="shipmentId'+totalRow+'" value="0" />'+
