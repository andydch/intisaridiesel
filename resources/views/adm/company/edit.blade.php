            ...
            <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/'.$folder.'/'.urlencode($company->slug)) }}" method="POST" enctype="application/x-www-form-urlencoded">
                ...
                <div class="col-xl-12 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Company Name*</label>
                                <div class="col-sm-9">
                                    <input type="text" id="companyName" name="companyName"
                                        class="form-control @error('companyName') is-invalid @enderror" maxlength="255"
                                        value="@if (old('companyName')){{ old('companyName') }}@else{{ $company->name }}@endif">
                                    @error('companyName')
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Office Address*</label>
                                <div class="col-sm-9">
                                    <textarea id="office_address" name="office_address" maxlength="1024"
                                        class="form-control @error('office_address') is-invalid @enderror"
                                        rows="3">@if(old('office_address')){{ old('office_address') }}@else{{ $company->office_address }}@endif</textarea>
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Province*</label>
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('province_id') is-invalid @enderror" id="province_id" name="province_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $provinceId = old('province_id')?old('province_id'):$company->province_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">City*</label>
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('city_id') is-invalid @enderror" id="city_id" name="city_id">
                                        <option value="#">Choose...</option>
                                        @php
                                        $cityId = old('city_id')?old('city_id'):$company->city_id;
                                        @endphp
                                        @foreach ($cities as $c)
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">District*</label>
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('district_id') is-invalid @enderror" id="district_id" name="district_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $districtId = old('district_id')?old('district_id'):$company->district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Sub District*</label>
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('subdistrict_id') is-invalid @enderror" id="subdistrict_id" name="subdistrict_id">
                                        <option value="#">Choose...</option>
                                        @php
                                            $subdistrictId = old('subdistrict_id')?old('subdistrict_id'):$company->sub_district_id;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Postcode*</label>
                                <div class="col-sm-9">
                                    <input type="text" id="postcode" name="postcode" class="form-control @error('postcode') is-invalid @enderror" maxlength="6"
                                        value="@if (old('postcode')){{ old('postcode') }}@else{{ $company->post_code }}@endif">
                                    @error('postcode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Company Email*</label>
                                <div class="col-sm-9">
                                    <input type="email" id="company_email" name="company_email" class="form-control @error('company_email') is-invalid @enderror"
                                        maxlength="64" value="@if (old('company_email')){{ old('company_email') }}@else{{ $company->company_email }}@endif">
                                    @error('company_email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Phone 1*</label>
                                <div class="col-sm-9">
                                    <input type="text" id="phone1" name="phone1" class="form-control @error('phone1') is-invalid @enderror" maxlength="32"
                                        value="@if (old('phone1')){{ old('phone1') }}@else{{ $company->phone1 }}@endif">
                                    @error(' phone1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <label for="country_id" class="col-sm-3 col-form-label">Phone 2</label>
                                <div class="col-sm-9">
                                    <input type="text" id="phone2" name="phone2" class="form-control @error('phone2') is-invalid @enderror" maxlength="32"
                                        value="@if (old('phone2')){{ old('phone2') }}@else{{ $company->phone2 }}@endif">
                                    @error('phone2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            @if ($company->id==1)
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP no</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="npwp_no" name="npwp_no"
                                            class="form-control @error('npwp_no') is-invalid @enderror" maxlength="24"
                                            value="@if (old('npwp_no')){{ old('npwp_no') }}@else{{ $company->npwp_no }}@endif">
                                        @error('npwp_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP Address</label>
                                    <div class="col-sm-9">
                                        <textarea id="npwp_address" name="npwp_address" maxlength="1024"
                                            class="form-control @error('npwp_address') is-invalid @enderror"
                                            rows="3">@if (old('npwp_address')){{ old('npwp_address') }}@else{{ $company->npwp_address }}@endif</textarea>
                                        @error('npwp_address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP Province</label>
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('npwp_province_id') is-invalid @enderror" id="npwp_province_id" name="npwp_province_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $npwp_provinceId = old('npwp_province_id')?old('npwp_province_id'):$company->npwp_province_id;
                                            @endphp
                                            @foreach ($province as $p)
                                ...
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP City</label>
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('npwp_city_id') is-invalid @enderror" id="npwp_city_id" name="npwp_city_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $npwp_cityId = old('npwp_city_id')?old('npwp_city_id'):$company->npwp_city_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP District</label>
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('npwp_district_id') is-invalid @enderror" id="npwp_district_id" name="npwp_district_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $npwp_districtId = old('npwp_district_id')?old('npwp_district_id'):$company->npwp_district_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    <label for="country_id" class="col-sm-3 col-form-label">NPWP Sub District</label>
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('npwp_subdistrict_id') is-invalid @enderror" id="npwp_subdistrict_id" name="npwp_subdistrict_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $npwp_subdistrictId = old('npwp_subdistrict_id')?old('npwp_subdistrict_id'):$company->npwp_sub_district_id;
                                            @endphp
                                        ...
                                        @for ($i = 0; $i < $totRow; $i++) <tr id="row{{ $i }}">
                                            ...
                                            <td>
                                                <select class="form-select single-select @error('coa_id'.$i) is-invalid @enderror"
                                                    ...
                                                    @endphp
                                                    @foreach ($coas as $c)
                                                        <option @if ($coaId==$c->id){{ 'selected' }}@endif
                                                            value="{{ $c->id }}">{{ $c->coa_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('coa_id'.$i)
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    @else
                                        ...
                                        @foreach ($queryBank as $b)
                                            <tr id="row{{ $i }}">
                                                <th scope="row">
                                                    {{ $i+1 }}
                                                    <input type="hidden" name="bank_id_{{ $i }}" id="bank_id_{{ $i }}"
                                                        value="{{ $b->id }}">
                                                </th>
                                                <td>
                                                    <input type="text" class="form-control" id="bank_name{{ $i }}"
                                                        name="bank_name{{ $i }}" maxlength="255"
                                                        value="{{ $b->bank_name }}" />
                                                </td>
                                                <td>
                                                    <textarea id="bank_address{{ $i }}" name="bank_address{{ $i }}"
                                                        maxlength="1024" class="form-control" rows="3"
                                                        aria-label="address">{{ $b->bank_address }}</textarea>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" id="account_name{{ $i }}"
                                                        name="account_name{{ $i }}" maxlength="255"
                                                        value="{{ $b->account_name }}" />
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" id="account_no{{ $i }}"
                                                        name="account_no{{ $i }}" maxlength="255"
                                                        value="{{ $b->account_no }}" />
                                                </td>
                                                <td>
                                                    <select class="form-select single-select" id="coa_id{{ $i }}" name="coa_id{{ $i }}">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $coaId = $b->coa_id;
                                                        @endphp
                                                ...
                                                <td>
                                                    <select class="form-select single-select" id="currency_bank_id{{ $i }}" name="currency_bank_id{{ $i }}">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $currencyBankId = $b->currency_id;
                                                        @endphp
                                                        @foreach ($currency as $c)
                                                            <option @if ($currencyBankId==$c->id){{ 'selected' }}@endif
                                                                value="{{ $c->id }}">{{ $c->title_ind }}</option>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="swift_code{{ $i }}" name="swift_code{{ $i }}" maxlength="255" value="{{ $b->swift_code }}" />
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" id="bsb_code{{ $i }}" name="bsb_code{{ $i }}" maxlength="255" value="{{ $b->bsb_code }}" />
                                                </td>
                                                <td>
                                                    <input type="checkbox" id="rowCheck{{ $i }}" value="{{ $i }}">
                                                </td>
    ...
    $(document).ready(function() {
        ...
        $("#btn-add-row").click(function() {
            ...
            let vHtml = '<tr id="row'+totalRow+'">'+
                ...
                '<td><input type="text" class="form-control" id="bank_name'+totalRow+'" name="bank_name'+totalRow+'" maxlength="255" /></td>'+
                '<td><textarea id="bank_address'+totalRow+'" name="bank_address'+totalRow+'" maxlength="1024" class="form-control" rows="3" aria-label="bank_address"></textarea></td>'+
                '<td><input type="text" class="form-control" id="account_name'+totalRow+'" name="account_name'+totalRow+'" maxlength="255" /></td>'+
                '<td><input type="text" class="form-control" id="account_no'+totalRow+'" name="account_no'+totalRow+'" maxlength="255" /></td>'+
                '<td><select class="form-select single-select" id="coa_id'+totalRow+'" name="coa_id'+totalRow+'">'+
                '<option value="#">Choose...</option>{!! $coaHtml !!}</select></td>'+
                '<td><select class="form-select single-select" id="currency_bank_id'+totalRow+'" name="currency_bank_id'+totalRow+'">'+
                '<option value="#">Choose...</option>{!! $currencyHtml !!}</select></td>'+
                '<td><input type="text" class="form-control" id="swift_code'+totalRow+'" name="swift_code'+totalRow+'" maxlength="255" /></td>'+
