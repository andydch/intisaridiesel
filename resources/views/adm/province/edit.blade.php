        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    ...
                    <hr />
                    <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/province/'.$province->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="provinceName" name="provinceName" class="form-control @error('provinceName') is-invalid @enderror" maxlength="128"
                                            aria-label="Title (Ind)" value="@if(old('provinceName')){{ old('provinceName') }}@else{{ $province->province_name }}@endif">
                                        @error('provinceName')
                                ...
                                <div class="row mb-3">
                                    <label for="provinceName" class="col-sm-3 col-form-label">Country Name*</label>
                                    <div class="col-sm-9">
                                        <select class="form-select single-select @error('country_id') is-invalid @enderror"
                                            id="country_id" name="country_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $countryId = old('country_id')?old('country_id'):$province->country_id;
                                            @endphp
