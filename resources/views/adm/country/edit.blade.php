        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 mx-auto">
                    ...
                    <hr />
                    <form id="submit-form" action="{{ url(ENV('ADMIN_FOLDER_NAME').'/country/'.$country->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
                        <div class="card">
                            <div class="card-body">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="countryName" name="countryName" class="form-control @error('countryName') is-invalid @enderror" maxlength="128"
                                            aria-label="Title (Ind)" value="@if(old('countryName')){{ old('countryName') }}@else{{ $country->country_name }}@endif">
                                        @error('countryName')
