                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('coa_level') is-invalid @enderror" id="coa_level" name="coa_level">
                                        @php
                                            $coa_level = old('coa_level')?old('coa_level'):0;
                                        @endphp
                                        @for ($i=1;$i<=5;$i++)
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select single-select @error('coa_parent') is-invalid @enderror" id="coa_parent" name="coa_parent">
                                        ...
                                        @php
                                            $coa_parent = old('coa_parent')?old('coa_parent'):0;
                                        @endphp
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="coa_code" name="coa_code"
                                        ...
                                        value="@if (old('coa_code')){{ old('coa_code') }}@endif">
                                    @error('coa_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="coa_name" name="coa_name"
                                        ...
                                        value="@if (old('coa_name')){{ old('coa_name') }}@endif">
                                    @error('coa_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-check-input" type="checkbox" id="is_master_coa" name="is_master_coa"
                                        @if (old('is_master_coa')=='on' ) {{ 'checked' }} @endif>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-check-input" type="checkbox" id="is_balance_sheet" name="is_balance_sheet"
                                        @if (old('is_balance_sheet')=='on' ) {{ 'checked' }} @endif>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-check-input" type="checkbox" id="is_profit_loss" name="is_profit_loss"
                                        @if (old('is_profit_loss')=='on' ) {{ 'checked' }} @endif>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-check-input" type="checkbox" id="is_cashflow" name="is_cashflow"
                                        @if (old('is_cashflow')=='on' ){{ 'checked' }}@endif>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="local_id" class="col-sm-3 col-form-label">Lokal</label>
                                <div class="col-sm-9">
                                    <select @if(old('is_master_coa')=='on') {{ 'disabled' }}@endif class="form-select single-select @error('local_id') is-invalid @enderror" id="local_id" name="local_id">
                                        @php
                                            $local_id = old('local_id')?old('local_id'):0;
                                        @endphp
                                        <option value="">---</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select @if(old('is_master_coa')=='on') {{ 'disabled' }}@endif class="form-select single-select @error('branch_id') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input @if(old('is_master_coa')=='on') {{ 'disabled' }}@endif readonly type="text"
                                        ...
                                        value="@if(old('beginning_balance_date')){{ old('beginning_balance_date') }}@endif">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input @if(old('is_master_coa')=='on') {{ 'disabled' }}@endif type="text" class="form-control @error('beginning_balance_amount') is-invalid @enderror"
                                        maxlength="25" id="beginning_balance_amount" name="beginning_balance_amount" onchange="formatAmount();" placeholder="Amount"
                                        value="@if(old('beginning_balance_amount')){{ old('beginning_balance_amount') }}@endif">
