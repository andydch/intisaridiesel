         ...
         <div class="page-content">
             @if (session('status-error'))
                 <div class="card radius-10">
                     <div class="row row-cols-12 row-cols-md-12 row-cols-xl-12 row-group g-0">
                         <div class="col">
                             <div class="card-body">
                     ...
                     <div class="col">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto">
                                     <i class='bx bx-cart fs-3 text-dark'></i>
                                 </div>
                             </div>
                     ...
                     <div class="col">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto">
                                     <i class='bx bx-dollar fs-3 text-dark'></i>
                                 </div>
                             </div>
                             <div class="progress my-3" style="height:3px;">
                                 <div class="progress-bar" role="progressbar" style="width: 55%" aria-valuenow="25"
                     ...
                     <div class="col">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto">
                                     <i class='bx bx-group fs-3 text-dark'></i>
                                 </div>
                             </div>
                             <div class="progress my-3" style="height:3px;">
                                 <div class="progress-bar" role="progressbar" style="width: 55%" aria-valuenow="25"
                     ...
                     <div class="col">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto">
                                     <i class='bx bx-envelope fs-3 text-dark'></i>
                                 </div>
                             </div>
                             <div class="progress my-3" style="height:3px;">
                                 <div class="progress-bar" role="progressbar" style="width: 55%" aria-valuenow="25"
                         ...
                         <div class="card-body">
                             ...
                             <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
                                 <span class="border px-1 rounded cursor-pointer"><i
                                         class="bx bxs-circle text-dark me-1"></i>New Visitor</span>
                                 <span class="border px-1 rounded cursor-pointer"><i
                     ...
                     <div class="card radius-10 overflow-hidden w-100">
                         ...
                         <div class="table-responsive">
                             <table class="table align-items-center mb-0">
                                 <tbody>
                                     <tr>
                                         <td><i class="bx bxs-circle text-dark me-2"></i> Direct</td>
                                         <td>$5856</td>
                                         <td>+55%</td>
                                     </tr>
                                     <tr>
                     ...
                     <div class="card radius-10">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto text-dark fs-1"><i class='bx bxl-facebook'></i></div>
                             </div>
                         </div>
                     </div>
                 </div>
                     ...
                     <div class="card radius-10">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto text-dark fs-1"><i class='bx bxl-twitter'></i></div>
                             </div>
                         </div>
                     </div>
                 </div>
                     ...
                     <div class="card radius-10">
                         <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="ms-auto text-dark fs-1"><i class='bx bxl-youtube'></i></div>
                             </div>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-12 col-lg-6 col-xl-8 d-flex">
                     <div class="card radius-10 w-100">
                         ...
                         <ul class="list-group list-group-flush">
                             ...
                             <li class="list-group-item bg-transparent">
                                 <div class="d-flex align-items-center">
                                     <img src="{{ asset('assets/images/avatars/avatar-5.png') }}" alt="user avatar"
                                         class="rounded-circle" width="55" height="55">
                                     <div class="ms-3">
