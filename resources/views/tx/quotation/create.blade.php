                        ...
                        <div class="card-body">
                            ...
                            <div class="border p-4 rounded">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select
                                            class="form-select single-select @error('supplier_id') is-invalid @enderror" id="supplier_id" name="supplier_id">
                                            <option value="#">Choose...</option>
                                            @php
                                                $supplierId = (old('supplier_id')?old('supplier_id'):0);
                                            @endphp
                                            @foreach ($suppliers as $p)
                                                <option @if ($supplierId==$p->id) {{ 'selected' }} @endif value="{{ $p->id }}">{{ (!is_null($p->entity_type)?$p->entity_type->title_ind:'').' '.$p->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('supplier_id')
                                ...
                                <div id="supplier_data" class="row mb-3">
                                    ...
                                    <div id="supplier_info" class="col-sm-9">
                                        @if(old('supplier_id'))
                                            ...
                                            {!!
                                            (!is_null($supplierPics[0]->supplier_type)?$supplierPics[0]->supplier_type->title_ind:'').' '.$supplierPics[0]->name.
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="header_txt" id="header_txt" rows="3" class="form-control @error('header_txt') is-invalid @enderror"
                                            style="width:100%;">@if (old('header_txt')){{ old('header_txt') }}@endif</textarea>
                                        @error('header_txt')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="footer_txt" id="footer_txt" rows="3" class="form-control @error('footer_txt') is-invalid @enderror"
                                            style="width:100%;">@if (old('footer_txt')){{ old('footer_txt') }}@endif</textarea>
                                        @error('footer_txt')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <tr id="row{{ $i }}">
                                                ...
                                                <td>
                                                    <select onchange="dispPartRef(this.value, {{ $i }});" class="form-select partsAjax @error('part_id'.$i) is-invalid @enderror"
                                                        ...
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $partNoId = old('part_id'.$i) ?old('part_id'.$i) : 0;
                                                ...
                                                <td style="text-align: right;"><label id="final-cost-{{ $i }}" for="" class="col-form-label">{{ number_format($partNo->final_cost,2,'.',',') }}</label></td>
                                                <td style="text-align: right;"><label id="avg-cost-{{ $i }}" for="" class="col-form-label">{{ number_format($partNo->avg_cost,2,'.',',') }}</label></td>
