                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror" id="customer_id" name="customer_id"
                                                        onchange="dispFKandSObyCust(this.value);">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('customer_id')?old('customer_id'):0);
                                                        @endphp
                                                        @foreach ($queryCustomer as $qS)
                                                            <option @if ($p_Id==$qS->id) {{ 'selected' }} @endif
                                                                value="{{ $qS->id }}">{{ $qS->customer_unique_code.' - '.(!is_null($qS->entity_type)?$qS->entity_type->title_ind:'').' '.$qS->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('customer_id')
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('faktur_id') is-invalid @enderror" id="faktur_id" name="faktur_id"
                                                        ...
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('faktur_id')?old('faktur_id'):0);
                                                        @endphp
                                            ...
                                            <input type="hidden" name="totRowSO" id="totRowSO" value="@if(old('totRowSO')){{ old('totRowSO') }}@else{{ 0 }}@endif">
                                            <input type="hidden" name="all_selected_SO" id="all_selected_SO" value="@if(old('all_selected_SO')){{ old('all_selected_SO') }}@endif">
                                            <div class="row mb-3">
                                                        ...
                                                        <tbody id="new-row-so">
                                                            @if (old('all_selected_SO'))
                                                                @php
                                                                    $iRow=0;
                                                                    $iRowNo=1;
                                                                    $all_selected_SO=explode(",",old('all_selected_SO'));
                                                                @endphp
                                            ...
                                            <input type="hidden" name="branch_id" id="branch_id" value="@if (old('branch_id')){{ old('branch_id') }}@endif">
                                            <div class="row mb-3">
                                            ...
                                            @if(old('part_id_'.$lastIdx))
                                                <tr id="rowSOdetail{{ $lastIdx }}">
                                                    ...
                                                    @if ($parts)
                                                        ...
                                                        @endphp
                                                        <td scope="row" style="text-align:right;">
                                                            <label for="" id="row_no_{{ $lastSoPartCounter }}" class="col-form-label">{{ $iRowPartNo }}.</label>
                                                        ...
                                                        <td scope="row" style="text-align:right;">
                                                            ...
                                                            <input type="hidden" id="total_ori_{{ $lastSoPartCounter }}" name="total_ori_{{ $lastSoPartCounter }}"
                                                                value="{{ $parts->price*old('qty_retur'.$lastSoPartCounter) }}">
                                                        </td>
                                                        <td scope="row" style="text-align:left;">
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                vHtml = '<tr id="rowSO'+lastCounter+'">'+
                    ...
                    '</td>'+
                    '<td>'+
                    '<label for="" name="cust_doc_no_'+lastCounter+'" id="cust_doc_no_'+lastCounter+'" class="col-form-label">'+(s.customer_doc_no!=null?s.customer_doc_no:'')+'</label>'+
                    '</td>'+
                    '<td style="text-align: center;"><input type="checkbox" id="rowSOCheck'+lastCounter+'" value="'+lastCounter+'"></td>'+
                    '</tr>';
