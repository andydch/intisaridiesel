...
<html lang="en">
    ...
    <head>
        ...
        <title>Nota Retur : {{ $returs->nota_retur_no }}</title>
            ...
            <table style="width: 100%;background-color: white;border:0px solid white !important;margin-bottom: 25px;">
                <tr style="border:0px solid white !important;">
                    <td style="width: 50%;text-align: left;border:0px solid white !important;">
                        ...
                        <span style="font-size: 10px;">NPWP: {{ $companyNPWP }}</span><br/>
                    </td>
            ...
            <table style="width: 100%;background-color: white;border:0px solid white !important;margin-bottom: 25px;">
                <tr style="border:0px solid white !important;">
                    <td style="width: 50%;text-align: left;border:0px solid white !important;">
                        ...
                        <span style="font-size: 12px;">FK No : {{ (!is_null($returs->delivery_order)?$returs->delivery_order->delivery_order_no:'') }}</span><br/>
                        {{-- <span style="font-size: 12px;">SO No : {{ $part_first->so_part->order->sales_order_no }}</span> --}}
                    ...
                    <td style="width: 50%;text-align: left;vertical-align: top;border:0px solid white !important;padding-left: 175px;">
                        ...
                        <span style="font-size: 12px;">{{ $returs->customer->city->city_name.' '.$returs->customer->post_code }}</span><br/>
                        <span style="font-size: 12px;">NPWP: {{ $returs->customer->npwp_no }}</span>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 100%;background-color: white;border:0px solid white !important;margin-bottom: 25px;">
                <tr style="border:0px solid white !important;">
                    <td style="width: 100%;text-align:center;border:0px solid white !important;">
                        <span style="font-size: 15;font-weight:bold;">NOTA RETUR</span>
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    ...
                    @foreach($parts AS $p)
                        <tr>
                            ...
                            <td class="val-num">{!! $p->qty_retur.'&nbsp;'.(!is_null($p->part->quantity_type)?$p->part->quantity_type->title_ind:'') !!}</td>
                            ...
                            <td class="val-str">{{ $p->so_part->order->sales_order_no }}</td>
                            @php
            ...
            <table style="width: 100%;background-color: white;border:0px solid white !important;margin-top: 15px;">
                ...
                <tr style="border:0px solid white !important;">
                    ...
                    <td style="width: 50%;text-align: left;vertical-align: top;border:0px solid white !important;padding-left: 175px;">
                        ...
                        {{-- <img src="{{ public_path('upl/employees/'.$owner->userDetail->signage_pic) }}" style="width: 100px;" alt=""><br/> --}}
                        <img src="{{ $_SERVER['DOCUMENT_ROOT'].'/upl/employees/'.$owner->userDetail->signage_pic }}" style="width: 100px;" alt=""><br/>
