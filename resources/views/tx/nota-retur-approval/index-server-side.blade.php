            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="nota-retur_approval" style="width:100%">
                        <thead>
                            <tr>
                                <th style="text-align: center;">NR No</th>
                                <th style="text-align: center;">FK No</th>
                                <th style="text-align: center;">Date</th>
                                <th style="text-align: center;">Customer</th>
                                <th style="text-align: center;">Total ({{ $qCurrency->string_val }})</th>
                                <th style="text-align: center;">Grand Total ({{ $qCurrency->string_val }})</th>
        ...
        $('#nota-retur_approval').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    name: 'tx_nota_returs.total_before_vat',
                    orderable: false,
                    searchable: false,
                },
                {
                    data: 'total_after_vat',
                    name: 'tx_nota_returs.total_after_vat',
                    orderable: false,
                    searchable: false,
                },
                {
