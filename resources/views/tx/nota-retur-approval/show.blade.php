                                    ...
                                    <div class="row">
                                        <div class="col-xl-8">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ (!is_null($qNotaRetur->branch)?$qNotaRetur->branch->name:'') }}</label>
                                            </div>
                                            <div class="row mb-3">
                            ...
                            <table class="table table-bordered mb-0">
                                        ...
                                        <tr id="rowSOdetail{{ $lastSoPartCounter }}">
                                            ...
                                            @if ($parts)
                                                @php
                                                    ...
                                                    $totalPriceRetur += ($qNRpart->final_price*$qNRpart->qty_retur);
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        {{-- <td style="text-align: right;">
                                            <label for="" id="total_before_vat_retur">{{ $qCurrency->string_val.number_format($totalPriceRetur,0,'.',',') }}</label>
                                        </td> --}}
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        {{-- <td style="text-align: right;">
                                            <label for="" id="vat_total_retur">{{ $qCurrency->string_val.number_format($totalPriceRetur*$vat/100,0,'.',',') }}</label>
                                        </td> --}}
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        {{-- <td style="text-align: right;">
                                            <label for="" id="grand_total">{{ $qCurrency->string_val.number_format($totalPriceRetur+($totalPriceRetur*$vat/100),0,'.',',') }}</label>
                                        </td> --}}
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
