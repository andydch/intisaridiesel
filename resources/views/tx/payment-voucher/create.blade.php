                        ...
                        <div class="card-body">
                            ...
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        @if($errors->has('next_plan_date') || old('next_plan_date'))
                                            <input 
                                                type="text" 
                                                class="form-control @error('next_plan_date') is-invalid @enderror"
                                                maxlength="10" 
                                                id="next_plan_date" 
                                                name="next_plan_date" 
                                                placeholder="Date"
                                                value="{{ old('next_plan_date') }}"
                                                readonly>
                                            ...
                                            @enderror
                                        @else
                                            <input type="hidden" name="next_plan_date" id="next_plan_date">
                                        @endif
                                    </div>
                                </div>
