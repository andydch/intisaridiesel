        ...
        <div class="row">
            <form id="submit-form" action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder) }}" method="POST" enctype="application/x-www-form-urlencoded">
                ...
                <div class="col-xl-12 mx-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            {{-- @if ($payment_type_id=='P')
                                                @php
                                                    $grandTotalTerbayar = $totTerbayar+(($totTerbayar*$qVat->numeric_val)/100)+
                                            ...
                                            @else
                                                @php
                                                    $grandTotalTerbayar = $totTerbayar+
                                                        (float)str_replace(",","",old('admin_bank'))+
                                                        (float)str_replace(",","",old('biaya_kirim'))+
                                                        (float)str_replace(",","",old('biaya_asuransi'))-
                                                        (float)str_replace(",","",old('diskon_pembelian'));
                    ...
                    {{-- <div id="other-fee" class="card" @if(old('payment_mode_id')==2 || old('payment_mode_id')==3){!! 'style="margin-top: 15px;display:block;"' !!}@else{!! 'style="margin-top: 15px;display:none;"' !!}@endif> --}}
                        <div class="card-body">
                            <div class="row mb-3" id="admin-bank-row">
                                ...
                                <div class="col-sm-6">
                                    <input onkeyup="formatPartPrice($(this));" type="text" class="form-control @error('admin_bank') is-invalid @enderror"
                                        id="admin_bank" name="admin_bank" placeholder="0" value="@if(old('admin_bank')){{ old('admin_bank') }}@else{{ 0 }}@endif">
                                    @error('admin_bank')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
