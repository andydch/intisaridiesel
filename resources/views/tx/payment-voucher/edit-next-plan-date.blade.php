    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="submit-form" method="POST" enctype="application/x-www-form-urlencoded"
                action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/payment-voucher-npd-upd/'.(!is_null($qPaymentInv->payment_voucher_no)?
                    urlencode($qPaymentInv->payment_voucher_no):
                    urlencode($qPaymentInv->payment_voucher_plan_no))) }}">
                @csrf
                @method('PUT')
...
<script>
    $(document).ready(function() {
        ...
        $("#save").click(function() {
            if(!confirm("Next Plan Date will be updated. Make sure the data entered is correct.\nContinue?")){
