                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            {{-- @if ($qPaymentInv->payment_type_id=='P')
                                @php
                                    $grandTotalTerbayar = $qPaymentInv->payment_total+(($qPaymentInv->payment_total*$qVat->numeric_val)/100)+
                            ...
                            @else
                                @php
                                    $grandTotalTerbayar = $qPaymentInv->payment_total+
                                        $qPaymentInv->admin_bank+
                                        $qPaymentInv->biaya_kirim+
                                        $qPaymentInv->biaya_asuransi-
                                        $qPaymentInv->diskon_pembelian;
