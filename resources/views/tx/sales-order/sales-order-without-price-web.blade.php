                    ...
                    {{-- <tr style="border-top: 1px solid black;">
                        <td colspan="5" rowspan="3" style="text-align:left;vertical-align:top;">
                            ...
                            @if ($sales_orders->is_vat=='Y')
                                {{ terbilang($tot+($tot*$sales_orders->vat_val/100)) }}
                            @else
                                {{ terbilang($tot) }}
                            @endif
                        </td>
                        <td class="val-num" style="border: 0px solid black;">Total</td>
                        <td class="val-num" style="border: 0px solid black;">{{ number_format($tot,0,'.',',') }}</td>
                    </tr>
                    <tr>
                        <td class="val-num" style="border: 0px solid black;">VAT</td>
                        <td class="val-num" style="border: 0px solid black;">{{ number_format($tot*$sales_orders->vat_val/100,0,'.',',') }}</td>
                    </tr>
                    <tr>
                        <td class="val-num" style="border: 0px solid black;">Grand Total</td>
                        <td class="val-num" style="border: 0px solid black;">{{ number_format($tot+($tot*$sales_orders->vat_val/100),0,'.',',') }}</td>
                    </tr> --}}
                </tbody>
            </table>
