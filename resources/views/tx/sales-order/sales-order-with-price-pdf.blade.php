    ...
    <body>
        ...
        <main>
            ...
            @for ($page=1;$page<=$pageTotal;$page++)
                <table style="width: 100%;margin-bottom: 5px; @if(fmod($page,2)==0){{ 'margin-top:100px;' }}@else{{ 'margin-top:50px;' }}@endif">
                    <tbody>
                        <tr>
                ...
                <table style="width: 100%;margin-bottom: 5px;">
                    ...
                    <tbody>
                        @foreach($qSoPart AS $p)
                            <tr style="@if(fmod($i,$rowsPerPage)==0){{ 'border-bottom: 1px solid black;' }}@endif">
                        ...
                        @if ($page==$pageTotal)
                            ...
                            <tr style="border-top: 1px solid black;border-right: 1px solid black;">
                                <td colspan="5" rowspan="3" style="text-align:left;vertical-align:top;border-right:1px solid black;border-top:1px solid black;">
                                    Terbilang:
                            ...
                            <tr style="border-right: 1px solid black;border-bottom: 1px solid black;">
                                <td class="val-num" style="border-bottom:1px solid black;">Grand Total</td>
                                <td class="val-num" style="border-bottom:1px solid black;">{{ number_format($tot+($tot*$sales_orders->vat_val/100),0,'.',',') }}</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
