    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="submit-form" method="POST" enctype="application/x-www-form-urlencoded"
                action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/payment-receipt-npd-upd/'.(!is_null($qPaymentInv->payment_receipt_no)?
                    urlencode($qPaymentInv->payment_receipt_no):
                    urlencode($qPaymentInv->payment_receipt_plan_no))) }}">
                @csrf
                @method('PUT')
