                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label doc-no">{{ $qKwi->kwitansi_no }}</label>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror"
                                                        id="customer_id" name="customer_id" onchange="dispDObyCustomer(this.value,{{ $qKwi->id }});">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('customer_id')?old('customer_id'):$qKwi->customer_id);
                                                        @endphp
                                                        @foreach ($qCust as $qC)
                                            ...
                                            @php
                                                $iRowFK = 0;
                                            @endphp
                                            <input type="hidden" name="totRowNP" id="totRowNP" value="@if(old('totRowNP')){{ old('totRowNP') }}@else{{ $all_selected_NP_count_from_db }}@endif">
                                            <input type="hidden" name="all_selected_NP" id="all_selected_NP" value="@if(old('all_selected_NP')){{ old('all_selected_NP') }}@else{{ $all_selected_NP_from_db }}@endif">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                                ...
                                                                @for ($lastCounter=0;$lastCounter<count($all_selected_NP);$lastCounter++)
                                                                    @if ($all_selected_NP[$lastCounter]!='')
                                                                        ...
                                                                        <tr id="rowNP{{ $lastCounter }}">
                                                                            ...
                                                                            <td style="text-align: center;"><input type="checkbox" id="rowNPCheck{{ $lastCounter }}" value="{{ $qNP->id }}"></td>
                                                                        </tr>
                                                                    @endif
                                                                @endfor
                                                            @else
                                                    ...
                                                    <input type="button" id="del-row-np" class="btn btn-danger px-5" value="Remove Row" style="margin-top: 5px;">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('payment_to_id') is-invalid @enderror" id="payment_to_id" name="payment_to_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $payment_to_id = (old('payment_to_id')?old('payment_to_id'):$qKwi->payment_to_id);
                                                        @endphp
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('kwitansi_date') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('kwitansi_date')){{ old('kwitansi_date') }}@else{{ date_format(date_create($qKwi->kwitansi_date),"d/m/Y") }}@endif">
                                                    @error('kwitansi_date')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $branchId = (old('branch_id')?old('branch_id'):$qKwi->branch_id);
                                                        @endphp
                                            ...
                                            @else
                                            <input type="hidden" name="branch_id" id="branch_id" value="@if(old('branch_id')){{ old('branch_id') }}@else{{ $qKwi->branch_id }}@endif">
                                            @endif
                                            <div class="row mb-3">
