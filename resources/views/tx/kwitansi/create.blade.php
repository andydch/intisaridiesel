                ...
                <div class="col-xl-12 mx-auto">
                                ...
                                <div class="col-xl-9">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror"
                                                        id="customer_id" name="customer_id" onchange="dispDObyCustomer(this.value);">
                                            ...
                                            <div class="row mb-3">
                                                <label for="delivery_order_id" class="col-sm-3 col-form-label">NP No*</label>
                                                <div class="col-sm-5">
                                                    <select class="form-select single-select @error('all_selected_NP') is-invalid @enderror"
                                                        id="delivery_order_id" name="delivery_order_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('delivery_order_id')?old('delivery_order_id'):0);
                                                        @endphp
                                                        @foreach ($deliveryOrders as $qC)
                                                            <option @if($p_Id==$qC->id){{ 'selected' }}@endif value="{{ $qC->id }}">{{ $qC->delivery_order_no }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('all_selected_NP')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="button" id="gen-np" class="btn btn-primary px-5" value="Generate NP">
                                                </div>
                                            </div>
                                            @php
                                                $iRowFK = 0;
                                            @endphp
                                            <input type="hidden" name="totRowNP" id="totRowNP" value="@if(old('totRowNP')){{ old('totRowNP') }}@else{{ 0 }}@endif">
                                            <input type="hidden" name="all_selected_NP" id="all_selected_NP" value="@if(old('all_selected_NP')){{ old('all_selected_NP') }}@endif">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <table id="fk-tables" class="table table-bordered mb-0">
                                                        ...
                                                        <tbody id="new-row-np">
                                                            @if (old('all_selected_NP'))
                                                                @php
                                                                    $iRow=0;
                                                                    $all_selected_NP=explode(",", old('all_selected_NP'));
                                                                @endphp
                                                                @for ($lastCounter=0;$lastCounter<count($all_selected_NP);$lastCounter++)
                                                                    @if ($all_selected_NP[$lastCounter]!='')
                                                                        @php
                                                                            $iRow+=1;
                                                                            $qFK = \App\Models\Tx_delivery_order_non_tax::where('delivery_order_no','=',$all_selected_NP[$lastCounter])
                                                                            ->first();
                                                                        @endphp
                                                                        <tr id="rowNP{{ $lastCounter }}">
                                                                            <td scope="row" style="text-align:right;vertical-align:middle;">
                                                                                <label for="" id="nota-penjualan{{ $lastCounter }}" class="col-form-label">{{ $iRow }}.</label>
                                                                            </td>
                                                                            <td>
                                                                                <label for="" name="np_no{{ $lastCounter }}" id="np_no{{ $lastCounter }}"
                                                                                    class="col-form-label">{{ $all_selected_NP[$lastCounter] }}</label>
                                                                                <input type="hidden" name="np_id{{ $lastCounter }}" id="np_id{{ $lastCounter }}" value="{{ $lastCounter }}">
                                                                            </td>
                                                                            <td style="text-align: center;"><input type="checkbox" id="rowNPCheck{{ $lastCounter }}" value="{{ $qFK->id }}"></td>
                                                                        </tr>
                                                                    @endif
                                                                @endfor
                                                            @endif
                                                    ...
                                                    <input type="button" id="del-row-fk" class="btn btn-danger px-5" value="Remove Row" style="margin-top: 5px;">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="payment_to_id" class="col-sm-3 col-form-label">Payment To*</label>
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('payment_to_id') is-invalid @enderror" id="payment_to_id" name="payment_to_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $payment_to_id = (old('payment_to_id')?old('payment_to_id'):0);
                                                        @endphp
                                                        @foreach ($qPaymentTo as $qP)
                                                            <option @if($payment_to_id==$qP->id){{ 'selected' }}@endif value="{{ $qP->id }}">{{ $qP->coa_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('payment_to_id')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="row mb-3">
                                                <label for="kwitansi_date" class="col-sm-3 col-form-label">Plan Date*</label>
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('kwitansi_date') is-invalid @enderror"
                                                        maxlength="10" id="kwitansi_date" name="kwitansi_date" placeholder="Date"
                                                        value="@if(old('kwitansi_date')){{ old('kwitansi_date') }}@endif">
                                                    @error('kwitansi_date')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="header" id="header" rows="3" class="form-control @error('header') is-invalid @enderror"
                                                        style="width: 100%;">@if (old('header')){{ old('header') }}@endif</textarea>
                                                    @error('header')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="footer" id="footer" rows="3" class="form-control @error('footer') is-invalid @enderror"
                                                        style="width: 100%;">@if (old('footer')){{ old('footer') }}@endif</textarea>
                                                    @error('footer')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                    ...
                    <div class="card" style="margin-top: 15px;">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="totalValafterVAT" id="totalValafterVAT" value="@if(old('totalValafterVAT')){{ old('totalValafterVAT') }}@else{{ 0 }}@endif">
                                        ...
                                        @for ($lastCounter=0;$lastCounter<count($all_selected_NP);$lastCounter++)
                                            @if ($all_selected_NP[$lastCounter]!='')
                                                @php
                                                    // $iRow+=1;
                                                    $vat=0;
                                                    $qFK = \App\Models\Tx_delivery_order_non_tax::where('tx_delivery_order_non_taxes.delivery_order_no','=',$all_selected_NP[$lastCounter])
                                                    ->first();
                                                @endphp
                                                @if ($qFK)
                                                    @php
                                                        ...
                                                        $all_cust_doc_no='';
                                                        $grandTotalVal+=($qFK->total_price-$retur_total_price);
                                                    @endphp
                                                    ...
                                                    <tr id="rowNPdetail{{ $iRow }}">
                                                        ...
                                                        <td scope="row" style="text-align:left;">
                                                            <label for="" id="np_no_dtl{{ $iRow }}" class="col-form-label">{{ $qFK->delivery_order_no }}</label>
                                                        </td>
                                                        <td scope="row" style="text-align:left;">
                                                        ...
                                                        <td scope="row" style="text-align:right;">
                                                            <label for="" id="total_after_vat_dtl{{ $iRow }}" class="col-form-label">{{ number_format(($qFK->total_price-$retur_total_price),0,'.',',') }}</label>
                                                        </td>
                                                        <td scope="row" style="text-align:left;">
                            ...
                            <input type="hidden" name="totRowNPdetail" id="totRowNPdetail" value="@if(old('totRowNPdetail')){{ old('totRowNPdetail') }}@else{{ 0 }}@endif">
                        </div>
                    </div>
                    <div class="card" style="margin-top: 15px;">
                        <div class="card-body">
