...
<html lang="en">
    ...
    <head>
        ...
        <title>Kwitansi : {{ $qKwi->kwitansi_no }}</title>
                ...
                <tr style="border:1px solid black !important;">
                    ...
                    <td style="width: 85%;text-align: left;vertical-align: top;padding: 5px;">
                        <table class="no_border" style="width: 100%;">
                            <tr>
                                <td colspan="3" style="font-size: 18;font-weight:bold;text-align: center;">
                                    K W I T A N S I
                                </td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr>
                                <td style="text-align: left;width:23%;font-weight:bold;">Sudah terima dari</td>
                                <td style="text-align: left;width:2%;font-weight:bold;">:</td>
                                <td style="text-align: left;width:75%;font-weight:bold;">
                                    {{ (!is_null($qKwi->customer->entity_type)?$qKwi->customer->entity_type->string_val:'').' '.$qKwi->customer->name }}
                                </td>
                            </tr>
                            @php
                                $totalValbeforeVAT=0;
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;padding-top: 10px;padding-bottom: 10px;">
                                    <div class="jajarangenjang" style="font-size: 12px;font-weight:bold;">
                                        #{{ terbilang(number_format($totalValbeforeVAT,0,'','')) }}
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left;font-weight:bold;">:</td>
                                <td style="text-align: left;font-weight:bold;">Pembelian suku cadang dump truck</td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr><td>&nbsp;</td></tr>
                            <tr>
                                <td colspan="2" style="vertical-align:bottom;text-align: left;font-weight:bold;">
                                    &nbsp;<br/><br/><br/><br/><br/><br/>
                                    Terbilang {{ $qCurrency->string_val }} #{{ number_format($totalValbeforeVAT,0,'.',',') }}<br/>
                                </td>
                                <td style="font-weight:bold;">
                                    {{ $company->city->city_name }}, {{ $date_local->format('d F Y') }}<br/><br/><br/><br/><br/>{{ $companyName }}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-align: left;font-size:8px;">
                                    Pembayaran dengan BG/Cek atau Transfer:<br/>
                                    {{ $company_bank_info?$company_bank_info->account_name.' - '.$company_bank_info->bank_name.' '.$company_bank_info->account_no:'' }}
                                </td>
                            </tr>
                        </table>
                    </td>
