        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="kwitansi-list" style="width:100%">
                        <thead>
                            <tr>
                                <th style="text-align: left !important;">KW No</th>
...
<script>
    function printDoc(i,print_type){
        ...
        $('#print-id').val(i);
        let downloadLInk = '<a '+dl+' href="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/kwitansi-print?inv=') }}'+$('#print-id').val()+'&doc=1&p='+print_type+'" target="_new" class="btn btn-primary">Permohonan Pembayaran</a>&nbsp;'+
            '<a '+dl+' href="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/kwitansi-print?inv=') }}'+$('#print-id').val()+'&doc=2&p='+print_type+'" target="_new" class="btn btn-primary">Tanda Terima</a>&nbsp;'+
            '<a '+dl+' href="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/kwitansi-print?inv=') }}'+$('#print-id').val()+'&doc=3&p='+print_type+'" target="_new" class="btn btn-primary">Kwitansi</a>';
