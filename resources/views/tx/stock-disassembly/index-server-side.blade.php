            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="tx-stock-disassembly" style="width:100%">
                            <thead>
                                <tr>
                                    <th>SD No</th>
                                    <th>Date</th>
...
<script>
    $(document).ready(function() {
        // $('#tx-stock-disassembly').DataTable({
        //     'ordering': false,
        // });
        ...
        $('#tx-stock-disassembly').DataTable({
            ...
            columns: [{ // mengambil & menampilkan kolom sesuai tabel database
                    data: 'stock_disassembly_no',
                    name: 'tx_stock_disassemblies.stock_disassembly_no'
                },
                {
                    data: 'stock_disassembly_date',
                    name: 'stock_disassembly_date'
                },
                {
                    data: 'initial',
                    name: 'usr.initial'
