                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">
                                                    @if(!is_null($qStock->approved_by) && $qStock->active=='Y')
                                                        {{ 'Approved at '.
                                                            date_format(date_add(date_create($qStock->approved_at), 
                                                    ...
                                                    @if(!is_null($qStock->canceled_by) && $qStock->active=='Y')
                                                        {{ 'Rejected at '.
                                                            date_format(date_add(date_create($qStock->canceled_at), 
                                                            date_interval_create_from_date_string(ENV("WAKTU_ID")." hours")), 'd-M-Y H:i:s').
                                                            $qStock->canceledBy->name }}
                                                    @endif
                                                    @if(is_null($qStock->approved_by) && is_null($qStock->canceled_at) && $qStock->active=='Y' && strpos($qStock->stock_transfer_no,'Draft')==0)
                                        ...
                                        <div class="col-xl-6">
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ date_format(date_create($qStock->created_at), 'd-M-Y H:i:s') }}</label>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ (!is_null($qStock->received_at)?date_format(date_create($qStock->received_at), 'd-M-Y H:i:s'):'') }}</label>
                                            </div>
                                            <div class="row mb-3">
