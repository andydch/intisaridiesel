                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-xl-8">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror" id="customer_id" name="customer_id"
                                                        onchange="dispNPandSJbyCust(this.value);">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('nota_penjualan_id') is-invalid @enderror" id="nota_penjualan_id" name="nota_penjualan_id"
                                                        ...
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('nota_penjualan_id')?old('nota_penjualan_id'):0);
                                                        @endphp
                                            ...
                                            <input type="hidden" name="totRowSJ" id="totRowSJ" value="@if(old('totRowSJ')){{ old('totRowSJ') }}@else{{ 0 }}@endif">
                                            <input type="hidden" name="all_selected_SJ" id="all_selected_SJ" value="@if(old('all_selected_SJ')){{ old('all_selected_SJ') }}@endif">
                                            <div class="row mb-3">
                                                                    ...
                                                                    @if ($all_selected_SJ[$lastCounter]!='')
                                                                        ...
                                                                        <tr id="rowSJ{{ $lastCounter }}">
                                                                            ...
                                                                            <td style="text-align: center;vertical-align: middle;">
                                                                                <input type="checkbox" id="rowSJCheck{{ $lastCounter }}" value="{{ $lastCounter }}">
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                @endfor
                                                ...
                                                <tr id="rowSJdetail{{ $lastIdx }}">
                                                    @php
                                                        ...
                                                        ->select(
                                                            ...
                                                            'tx_surat_jalan_parts.surat_jalan_id',
    ...
    function countGrandTotal(){
        ...
        for (i = 0; i < $("#totalRow").val(); i++) {
            if(!isNaN($("#total_ori_"+i).val())){
                totalPrice += parseFloat($("#total_ori_"+i).val());
            }
        }
