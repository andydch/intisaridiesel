                                        ...
                                        @if (old('part_id'.$i))                                            
                                            <tr id="row{{ $i }}">
                                                ...
                                                @php
                                                    ...
                                                    $qtySO = 0;
                                                    $qSO = \App\Models\Tx_surat_jalan_part::leftJoin('tx_surat_jalans AS txso','tx_surat_jalan_parts.surat_jalan_id','=','txso.id')
                                                    ...
                                                    ->where([
                                                        'tx_surat_jalan_parts.part_id' => old('part_id'.$i),
                                                        'tx_surat_jalan_parts.active' => 'Y',
                                                        'txso.branch_id' => old('branch_id'),
                                                        'txso.active' => 'Y',
                                                    ])
...
<script>
    ...
    function dispPartRef(part_id, idx){
        ...
        $.ajax({
            url: "{{ url('/disp_quotation_part_surat_jalan_ref_info') }}",
            type: "POST",
