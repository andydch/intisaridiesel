    ...
    <body>
        ...
        <main>
            ...
            @for ($page=1;$page<=$pageTotal;$page++)
                <table style="width: 100%;background-color: white;margin-bottom: 5px; @if(fmod($page,2)==0){{ 'margin-top:100px;' }}@else{{ 'margin-top:50px;' }}@endif">
                    <tbody>
                        <tr>
                ...
                @php
                    $qSjPart = \App\Models\Tx_surat_jalan_part::where([
                        'surat_jalan_id' => $surat_jalans->id,
                        'active' => 'Y'
                    ])
                    ...
                    <tbody>
                        ...
                        @if ($page==$pageTotal)
                            ...
                            <tr style="border-top: 1px solid black;border-left: 1px solid black;border-right: 1px solid black;border-bottom:1px solid black;">
                                <td colspan="5" style="text-align:left;vertical-align:top;border-right:1px solid black;border-top:1px solid black;">
                                    Terbilang:{{ terbilang(number_format($tot,0,'.','')) }}
                                </td>
                                <td class="val-num" style="border-bottom: 1px solid black;">Total</td>
                                <td class="val-num" style="border-bottom: 1px solid black;">{{ number_format($tot,0,'.',',') }}</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
