    ...
    <body>
        <main>
            ...
            <table style="width: 100%;background-color: white;margin-bottom: 5px;">
                <tr>
                    <td style="width: 50%;text-align: left;">
                        <h2>{{ $surat_jalans->surat_jalan_no }}</h2>
                        <table style="width: 100%;">
                            <tbody>
                                <tr>
                                    <td style="width: 20%;text-align:left;">Date</td>
                                    <td style="width: 80%;text-align:left;">: {{ date_format(date_create($surat_jalans->sales_order_date),"d/m/Y") }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 20%;text-align:left;">PO No</td>
                                    <td style="width: 80%;text-align:left;">: {{ $surat_jalans->customer_doc_no }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 20%;text-align:left;">Sales</td>
                                    <td style="width: 80%;text-align:left;">: {{ $surat_jalans->createdBy->userDetail->initial }}</td>
                                </tr>
                                @php
                                    $due_date = date_create($surat_jalans->sales_order_date);
                    ...
                    <td style="width: 50%;text-align: left;vertical-align: top;padding-left: 150px;">
                        To : <br/>{{ (!is_null($surat_jalans->customer->entity_type)?$surat_jalans->customer->entity_type->string_val:'').' '.$surat_jalans->customer->name }}<br/>
                        {{ $surat_jalans->cust_office_address }}<br/>
                        {{ (!is_null($surat_jalans->city)?$surat_jalans->city->city_name:'').' '.$surat_jalans->post_code }}<br/>
            ...
            <table style="width: 100%;margin-bottom: 10px;">
                ...
                <tbody>
                    ...
                    <tr style="border-top: 1px solid black;">
                        <td colspan="5" style="border-top: 1px solid black;text-align:left;vertical-align:top;">
                            Terbilang:
                            {{ terbilang($tot) }}
                        </td>
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 70%;text-align:left;">{{ (!is_null($surat_jalans->courier)?$surat_jalans->courier->name:'') }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 70%;text-align:left;vertical-align: top;">
                                        {!! (!is_null($surat_jalans->customer_shipment)?$surat_jalans->customer_shipment->address.'<br/>'.$surat_jalans->customer_shipment->city->city_name:'') !!}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 27%;text-align:left;">Remark</td>
                                    <td style="width: 3%;text-align:left;">:</td>
                                    <td style="width: 70%;text-align:left;">{{ $surat_jalans->remark }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
