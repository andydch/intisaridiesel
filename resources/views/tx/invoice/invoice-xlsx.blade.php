            ...
            <table style="width:1024px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <th style="text-align: center;font-weight:bold;border:1px solid black;background-color:#daeef3;">FK Date</th>
                    ...
                    @php
                        ...
                        ->select(
                            ...
                            DB::raw('(SELECT DATE_FORMAT(tx_delivery_orders.delivery_order_date, "%d-%m-%Y") 
                                FROM tx_delivery_orders 
                                WHERE tx_delivery_orders.id IN (SELECT fk_id FROM tx_invoice_details WHERE invoice_id = tx_invoices.id) 
                                LIMIT 1) AS fk_date')
                        )
                    ...
                    @foreach ($qInvoices as $qInv)
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $qInv->fk_date }}</td>
