            ...
            <form id="submit-form" action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder) }}" method="POST" enctype="application/x-www-form-urlencoded">
                ...
                <div class="col-xl-12 mx-auto">
                                ...
                                <div class="col-xl-9">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror" id="customer_id" name="customer_id" 
                                                        onchange="dispDObyCustomer(this.value);">
                                                        ...
                                                        @foreach ($qCust as $qC)
                                                            <option @if($p_Id==$qC->id){{ 'selected' }}@endif
                                                                value="{{ $qC->id }}">{{ $qC->customer_unique_code.' - '.
                                                                (!is_null($qC->entity_type)?$qC->entity_type->title_ind:'').' '.
                                                                $qC->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('customer_id')
                                            ...
                                            <div class="row mb-3">
                                                <label for="delivery_order_id" class="col-sm-3 col-form-label">FK No*</label>
                                                <div class="col-sm-5">
                                                    <select class="form-select single-select @error('all_selected_FK') is-invalid @enderror"
                                                    ...
                                                    @error('all_selected_FK')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="button" id="gen-fk" class="btn btn-primary px-5" value="Generate FK">
                                                </div>
                                            </div>
                                            <input type="hidden" name="totRowFK" id="totRowFK" value="@if(old('totRowFK')){{ old('totRowFK') }}@else{{ 0 }}@endif">
                                            <input type="hidden" name="all_selected_FK" id="all_selected_FK" value="@if(old('all_selected_FK')){{ old('all_selected_FK') }}@endif">
                                            <div class="row mb-3">
                                                    ...
                                                    <table id="fk-tables" class="table table-bordered mb-0">
                                                        <thead>
                                                            <tr style="width: 100%;">
                                                                ...
                                                                <th scope="col" style="width: 94%;text-align:center;">FK No</th>
                                                        ...
                                                        <tbody id="new-row-fk">
                                                            ...
                                                            @if (old('all_selected_FK'))
                                                                @php
                                                                    $iRow=0;
                                                                    $all_selected_FK=explode(",",old('all_selected_FK'));
                                                                @endphp
                                                                    ...
                                                                    @if ($all_selected_FK[$lastCounter]!='')
                                                                        ...
                                                                        <tr id="rowFK{{ $lastCounter }}">
                                                                            <td scope="row" style="text-align:right;">
                                                                                <label for="" id="faktur_row_number{{ $lastCounter }}" class="col-form-label">{{ $iRowNo }}.</label>
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td style="text-align: center;vertical-align: middle;">
                                                                                <input type="checkbox" id="rowFKCheck{{ $lastCounter }}" value="{{ $qFK->id }}">
                                                                            </td>
                                                                        </tr>
                                                                        @php
                                                                            $iRowNo++;
                                            ...
                                            <div class="row mb-3">
                                                <label for="invoice_date" class="col-sm-3 col-form-label">Plan Date*</label>
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('invoice_date') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('invoice_date')){{ old('invoice_date') }}@endif">
                                                    @error('invoice_date')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                    ...
                    <div class="card" style="margin-top: 15px;">
                        <div class="card-body">
                            <input type="hidden" name="totRowFKdetail" id="totRowFKdetail" value="@if(old('totRowFKdetail')){{ old('totRowFKdetail') }}@else{{ 0 }}@endif">
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                vHtml = '<tr id="rowFKdetail'+lastFKdtlCounter+'">'+
                    ...
                    '<td scope="row" style="text-align:left;"><label for="" id="fp_no_dtl'+lastFKdtlCounter+'" class="col-form-label">'+fp_no+'</label></td>'+
