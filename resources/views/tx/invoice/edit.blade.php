                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label doc-no">{{ $qInv->invoice_no }}</label>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('customer_id') is-invalid @enderror"
                                                        ...
                                                        @php
                                                            $p_Id = (old('customer_id')?old('customer_id'):$qInv->customer_id);
                                                        @endphp
                                                        @foreach ($qCust as $qC)
                                                            ...
                                                            @else
                                                                ...
                                                                @for ($lastCounter=0;$lastCounter<count($all_selected_FK);$lastCounter++)
                                                                    @if ($all_selected_FK[$lastCounter]!='')
                                                                        ...
                                                                        <tr id="rowFK{{ $lastCounter }}">
                                                                            <td scope="row" style="text-align:right;">
                                                                                <label for="" id="faktur_row_number{{ $lastCounter }}" class="col-form-label">{{ $iRow }}.</label>
                                                                            </td>
                                                                            <td>
                                                                                <label for="" name="fk_no{{ $lastCounter }}" id="fk_no{{ $lastCounter }}"
                                                                                    class="col-form-label">{{ $all_selected_FK[$lastCounter] }}</label>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('payment_to_id') is-invalid @enderror" id="payment_to_id" name="payment_to_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $payment_to_id = (old('payment_to_id')?old('payment_to_id'):$qInv->payment_to_id);
                                                        @endphp
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('invoice_date') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('invoice_date')){{ old('invoice_date') }}@else{{ date_format(date_create($qInv->invoice_date),"d/m/Y") }}@endif">
                                                    @error('invoice_date')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $branchId = (old('branch_id')?old('branch_id'):$qInv->branch_id);
                                                        @endphp
                                            ...
                                            @else
                                            <input type="hidden" name="branch_id" id="branch_id" value="@if(old('branch_id')){{ old('branch_id') }}@else{{ $qInv->branch_id }}@endif">
                                            @endif
                                            <div class="row mb-3">
