...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <hr />
        <form name="form_search" id="form-search" action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder.'/gj-dt') }}" method="POST" enctype="application/x-www-form-urlencoded">
            @csrf
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#gj-list').DataTable({
            ...
            "pageLength": 10,
            ajax: {
                url: '{!! url(ENV('TRANSACTION_FOLDER_NAME').'/general-journal/gj-dt') !!}',
                // url: '{!! url()->current() !!}',
                type: 'POST',
                'headers': {
            ...
            columns: [{
                ...
                {
                    data: 'viewDoc',
                    name: 'tx_general_journals.module_no',
                    searchable: true,
                    orderable: false,
                },
                {
