                                ...
                                <div class="border p-4 rounded">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <label for="" id="part_name" class="col-sm-9 col-form-label"></label>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="to_be_part_qty" id="to_be_part_qty" class="form-control @error('to_be_part_qty') is-invalid @enderror"
                                                    value="@if (old('to_be_part_qty')){{ old('to_be_part_qty') }}@endif" style="text-align: right;">
                                                @error('to_be_part_qty')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <label for="" class="col-sm-3 col-form-label" style="text-align:right;">Total Cost ({{ $qCurrency->string_val }})</label>
                                            <label for="" id="final-cost" class="col-sm-3 col-form-label" style="text-align:right;">&nbsp;</label>
                                        </div>
                                        <div class="row mb-3">
