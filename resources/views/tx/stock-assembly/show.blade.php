                            ...
                            <div class="row">
                                <div class="border p-4 rounded">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="row mb-3">
                                            <label for="" class="col-sm-3 col-form-label">To be Part No</label>
                                            @php
                                                $partNumber = $stockAsm->part->part_number;
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <label for="" class="col-sm-3 col-form-label">{{ $stockAsm->qty }}</label>
                                            <label for="" class="col-sm-3 col-form-label" style="text-align:right;">Total Cost</label>
                                            <label for="" id="final-cost" class="col-sm-3 col-form-label" style="text-align:right;">{{ $qCurrency->string_val.number_format($stockAsm->final_cost,0,'.',',') }}</label>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="" class="col-sm-3 col-form-label">Remark</label>
                                            <label for="" class="col-sm-9 col-form-label">{{ $stockAsm->remark }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered mb-0">
                                        ...
                                        @foreach ($stockAsmPart as $asmPart)
                                            <tr id="row{{ $i }}">
                                                ...
                                                @if ($partNo)
                                                    ...
                                                    <td>
                                                        @php
                                                            $partNumber = $asmPart->part->part_number;
                                                            if(strlen($partNumber)<11){
                                                                $partNumber = substr($partNumber,0,5).'-'.substr($partNumber,5,strlen($partNumber));
                                                            }else{
                                                                $partNumber = substr($partNumber,0,5).'-'.substr($partNumber,5,5).'-'.substr($partNumber,10,strlen($partNumber));
                                                    ...
                                                    <td>
                                                        <label for="" id="" class="col-form-label">{{ $asmPart->qty }}</label>
                                                    </td>
                                                    <td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <label for="" id="total-avg-cost-val" class="col-form-label">{{ $qCurrency->string_val.number_format($total_avg_cost,0,'.',',') }}</label>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
...
<script>
    $(document).ready(function() {
        $("#final-cost").text("{{ $qCurrency->string_val.number_format($total_avg_cost,0,'.',',') }}");
