                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-select single-select @error('month_id') is-invalid @enderror" id="month_id" name="month_id">
                                        ...
                                        @php
                                            $monthId = (old('month_id')?old('month_id'):date_format(date_create($plans->acceptance_month),"m"));
                                        @endphp
                                ...
                                <div class="col-sm-3">
                                    <select class="form-select single-select @error('year_id') is-invalid @enderror" id="year_id" name="year_id">
                                        ...
                                        @php
                                            ...
                                            $yearId = (old('year_id')?old('year_id'):date_format(date_create($plans->acceptance_month),"Y"));
                                        @endphp
