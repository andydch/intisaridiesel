                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="row mb-3">
                                                <label for="so_date" class="col-sm-3 col-form-label">SO Date</label>
                                                <label for="so_date" class="col-sm-9 col-form-label">{{ date_format(date_create($queryDelivery->delivery_order_date), 'd/m/Y') }}</label>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <input type="hidden" name="sales_order_no_all" id="sales_order_no_all" class="@error('sales_order_no_all') is-invalid @enderror" 
    ...
    $(document).ready(function() {
        ...
        $("#del-btn").click(function() {
            ...
            if(!confirm(msg)){
                ...
                $('#submit-form').attr('action', "{{ url('/del_deliveryorder') }}");
                $("#submit-form").submit();
            }
        });
                    ...
                    success: function (res) {
                        ...
                        if (totOrder > 0) {
                            ...
                            for (let i = 0; i < totOrder; i++) {
                                ...
                                $("#price"+(totalRow-1)).text(o[i].price);
