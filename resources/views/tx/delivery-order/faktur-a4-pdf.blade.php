        ...
        <main>
            ...
            {{-- @for ($page=1;$page<=$pageTotal;$page++) --}}
                        ...
                        <tr>
                            <td style="width: 70%;">
                                <table style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            <td class="title-fk top-section" colspan="2">
                            ...
                            <td style="width: 30%;">
                                <table style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            <td class="title-fk top-section">
                                                To : <br/>
                                                <span style="font-weight: bold;">
                                                    {{ (!is_null($fakturs->customer->entity_type)?$fakturs->customer->entity_type->title_ind:'').' '.$fakturs->customer->name }}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="top-section" style="line-height:1.3rem;">
                ...
                <table style="width: 100%;margin-bottom: 5px;">
                    <tbody>
                        <tr>
                            <td class="title-main" style="width: 100%;text-align:center;font-size: 15px;font-weight:bold;">FAKTUR</td>
                        </tr>
                    </tbody>
                </table>
