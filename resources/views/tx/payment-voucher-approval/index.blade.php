                    ...
                    <table class="table table-striped table-bordered" id="recipt-order" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($query as $pV)
                                <tr>
                                    <td>
                                        <a href="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder.'/'.urlencode($pV->payment_voucher_no)) }}" style="text-decoration: underline;">{{ $pV->payment_voucher_no }}</a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if($pV->active=='Y' && strpos($pV->stock_transfer_no,'Draft')==0 && is_null($pV->approved_by) && is_null($pV->canceled_by))
