                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('supplier_id') is-invalid @enderror"
                                                        ...
                                                        @php
                                                            $supplier_id = (old('supplier_id')?old('supplier_id'):0);
                                                        @endphp
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <input type="hidden" id="totalRowRO" name="totalRowRO" value="@if(old('totalRowRO')){{ $iRow }}@else{{ 0 }}@endif">
                                                            <input type="button" id="btn-del-row-ro" class="btn btn-danger px-5 mt-3" value="Remove Row">
                                                            <input type="hidden" name="receipt_order_no_all" id="receipt_order_no_all" value="@if(old('receipt_order_no_all')){{ old('receipt_order_no_all') }}@endif">
                                                            <input type="hidden" name="vat_val" id="vat_val" value="@if(old('vat_val')){{ old('vat_val') }}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('payment_plan_date') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('payment_plan_date')){{ old('payment_plan_date') }}@endif">
                                            ...
                                            @if ($sNo!='')
                                                ...
                                                @if ($qS)
                                                    ...
                                                    <tr id="rowROdtl{{ $iRow }}">
                                                        ...
                                                        <td>
                                                            <label for="" name="prc_retur_no_{{ $iRow }}" id="prc_retur_no_{{ $iRow }}" class="col-form-label">{!! $purchase_retur_no !!}</label>
                                                        </td>
                                                    ...
                                                    @php
                                                        ...
                                                        // $lastTotalAmount += ($qS->ro_total_before_vat-$qS->pr_total_before_vat);
                                                    @endphp
                                                @endif
                                                @php
                                                    $iRow++;
...
<script>
            ...
            success: function (res) {
                ...
                if (totOrder > 0) {
                    ...
                    for (let j = 0; j<totPR; j++) {
                        ...
                        pr_total_vat += p[j].total_after_vat-p[j].total_before_vat;
                    }
                    ...
                    for (let i = 0; i < totOrder; i++) {
                        ...
                        // $('#total_price_'+(totalRowRO)).text(parseFloat(o[i].ro_total_before_vat-o[i].pr_total_before_vat).numberFormat(0,'.',','));
                        lastTotalAmountTmp += parseFloat(o[i].ro_total_before_vat-pr_total_before_vat);
                        // lastTotalAmountTmp += parseFloat(o[i].ro_total_before_vat-o[i].pr_total_before_vat);
    ...
    function recalcTotal(vat_num){
        ...
        // VatValNum = (totalAmount*lastVatTmp)/100;
        ...
        $('#lblGrandTotalAmount').text('{{ $qCurrency->string_val }}'+parseFloat(totalAmount+VatValNum).numberFormat(0,'.',','));
    }
