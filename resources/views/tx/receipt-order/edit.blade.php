    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="submit-form" action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder.'/'.$ro->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id" onchange="dispPoPm('');">
                                                        ...
                                                        @php
                                                            $p_Id = (old('branch_id')?old('branch_id'):$ro->branch_id);
                                                        @endphp
                                            ...
                                            @else
                                            <input type="hidden" name="branch_id" id="branch_id" value="@if (old('branch_id')){{ old('branch_id') }}@else{{ $ro->branch_id }}@endif">
                                            @endif
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('supplier_id') is-invalid @enderror"
                                                        ...
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $p_Id = (old('supplier_id')?old('supplier_id'):$ro->supplier_id);
                                                        @endphp
                                                        @foreach ($querySupplier as $qS)
                                                            <option @if ($p_Id==$qS->id) {{ 'selected' }} @endif value="{{ $qS->id }}">{{ (!is_null($qS->entity_type)?$qS->entity_type->title_ind:'').' '.$qS->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('supplier_id')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <input type="hidden" name="supplier_type_id" id="supplier_type_id"
                                                value="@if(old('supplier_type_id')){{ old('supplier_type_id') }}@else{{ $ro->supplier->supplier_type_id }}@endif">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control @error('invoice_no') is-invalid @enderror"
                                                        ...
                                                        value="@if (old('invoice_no')){{ old('invoice_no') }}@else{{ $ro->invoice_no }}@endif">
                                                    @error('invoice_no')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control @error('invoice_amount') is-invalid @enderror"
                                                        ...
                                                        placeholder="Enter Invoice Amount" onkeyup="formatAmount($(this));"
                                                        value="@if(old('invoice_amount')){{ old('invoice_amount') }}@else{{ number_format($ro->invoice_amount,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}@endif">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input {{ $readonly }} type="text" class="form-control @error('exc_rate') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('exc_rate')){{ old('exc_rate') }}@else{{ number_format($ro->exchange_rate,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}@endif">
                                                    @error('exc_rate')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input {{ $readonly }} type="text" class="form-control @error('vat_import') is-invalid @enderror"
                                                        ...
                                                        placeholder="Enter Exchange Rate" onchange="formatAmount($(this));"
                                                        value="@if(old('vat_import')){{ old('vat_import') }}@else{{ $ro->supplier->supplier_type_id==10?number_format($ro->total_vat_rp,2,'.',','):'' }}@endif">
                                                    @error('vat_import')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            {{-- <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input {{ $readonly }} type="text" class="form-control @error('exch_rate_for_vat') is-invalid @enderror"
                                                        ...
                                                        placeholder="Enter Exchange Rate" onchange="formatAmount($(this));"
                                                        value="@if(old('exch_rate_for_vat')){{ old('exch_rate_for_vat') }}@else{{ number_format($ro->exc_rate_for_vat,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}@endif">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input {{ $readonly }} type="text" class="form-control @error('bea_masuk_val') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('bea_masuk_val')){{ old('bea_masuk_val') }}@else{{ number_format($ro->bea_masuk,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}@endif">
                                                    @error('bea_masuk_val')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input {{ $readonly }} type="text" class="form-control @error('import_shipping_cost_val') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('import_shipping_cost_val')){{ old('import_shipping_cost_val') }}@else{{ number_format($ro->import_shipping_cost,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}@endif">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control @error('bl_no') is-invalid @enderror"
                                                        ...
                                                        value="@if (old('bl_no')){{ old('bl_no') }}@else{{ $ro->bl_no }}@endif">
                                                    @error('bl_no')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('vessel_no') is-invalid @enderror"
                                                        ...
                                                        value="@if (old('vessel_no')){{ old('vessel_no') }}@else{{ $ro->vessel_no }}@endif">
                                                    @error('vessel_no')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('weight_type_id01') is-invalid @enderror" id="weight_type_id01" name="weight_type_id01">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $weight_type_id01 = (old('weight_type_id01')?old('weight_type_id01'):$ro->weight_type_id01);
                                                        @endphp
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select single-select @error('weight_type_id02') is-invalid @enderror" id="weight_type_id02" name="weight_type_id02">
                                                        <option value="#">Choose...</option>
                                                        @php
                                                            $weight_type_id02 = (old('weight_type_id02')?old('weight_type_id02'):$ro->weight_type_id02);
                                                        @endphp
                                                        @foreach ($weighttype as $wT)
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <input type="hidden" name="po_pm_no_all" id="po_pm_no_all"
                                                    value="@if(old('po_pm_no_all')){{ old('po_pm_no_all') }}@else{{ $ro->po_or_pm_no }}@endif">
                                                ...
                                                <div class="col-sm-5">
                                                    <table class="table table-bordered mb-0">
                                                        ...
                                                        <tbody id="new-row-po-mo">
                                                            @php
                                                                $last_is_vat = (old('last_is_vat')?old('last_is_vat'):'');
                                                            @endphp
                                                            @if (old('po_pm_no_all'))
                                                                @php
                                                                ...
                                                                @for ($i=0;$i<count($po_mo_no_arr);$i++)
                                                                    @if ($po_mo_no_arr[$i]!='')
                                                                        @if (strpos("-".$po_mo_no_arr[$i],env("P_PURCHASE_MEMO"))>0)
                                                                            @php
                                                                                $qMO = \App\Models\Tx_purchase_memo::select('is_vat')
                                                                                ->where([
                                                                                    'memo_no'=>$po_mo_no_arr[$i],
                                                                                ])
                                                                                ->first();
                                                                                if ($qMO){
                                                                                    $last_is_vat = $qMO->is_vat;
                                                                                }
                                                                            @endphp
                                                                        @endif
                                                                        @if (strpos("-".$po_mo_no_arr[$i],env('P_PURCHASE_ORDER'))>0)
                                                                            @php
                                                                                $qPO = \App\Models\Tx_purchase_order::select('is_vat')
                                                                                ->where([
                                                                                    'purchase_no'=>$po_mo_no_arr[$i],
                                                                                ])
                                                                                ->first();
                                                                                if ($qPO){
                                                                                    $last_is_vat = $qPO->is_vat;
                                                                                }
                                                                            @endphp
                                                                        @endif
                                                                        <tr id="row_po_mo_{{ $i }}">
                                                    ...
                                                    <input type="hidden" name="last_is_vat" id="last_is_vat" value="@if(old('last_is_vat')){{ old('last_is_vat') }}@else{{ $last_is_vat }}@endif">
                                                    <input type="hidden" name="totalRowPoMo" id="totalRowPoMo" value="@if (old('totalRowPoMo')){{ old('totalRowPoMo') }}@else{{ $iRow }}@endif">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="hidden" name="currency_id" id="currency_id" value="@if(old('currency_id')){{ old('currency_id') }}@else{{ $ro->currency_id }}@endif">
                                                    <input readonly type="text" class="form-control @error('currency_name') is-invalid @enderror"
                                                        ...
                                                        value="@if (old('currency_name')){{ old('currency_name') }}@else{{ (!is_null($ro->currency)?$ro->currency->title_ind:'') }}@endif">
                                                    @error('currency_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly type="text" class="form-control @error('exc_rate_inv_amount') is-invalid @enderror"
                                                        ...
                                                        value="@if(old('exc_rate_inv_amount')){{ old('exc_rate_inv_amount') }}
                                                            @else{{ number_format(($ro->exchange_rate*$ro->invoice_amount),0,'.',',') }}@endif">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-select" name="courier_type" id="courier_type">
                                                        <option @if(old('courier_type')==env('AMBIL_SENDIRI') || $ro->courier_type==env('AMBIL_SENDIRI')){{ 'selected' }}@endif value="{{ env('AMBIL_SENDIRI') }}">{{ env('AMBIL_SENDIRI_STR') }}</option>
                                                        <option @if(old('courier_type')==env('DIANTAR') || $ro->courier_type==env('DIANTAR')){{ 'selected' }}@endif value="{{ env('DIANTAR') }}">{{ env('DIANTAR_STR') }}</option>
                                                        <option @if(old('courier_type')==env('COURIER') || $ro->courier_type==env('COURIER')){{ 'selected' }}@endif value="{{ env('COURIER') }}">{{ env('COURIER_STR') }}</option>
                                                    </select>
                                                </div>
                                                <div id="courier-list" class="col-sm-6" style="@if(old('courier_type')==env('COURIER') || $ro->courier_type==env('COURIER')){{ 'display: block;' }}@else{{ 'display: none;' }}@endif">
                                                    <select class="form-select single-select @error('courier_id') is-invalid @enderror" id="courier_id" name="courier_id">
                                                        <option value="">Choose...</option>
                                                        @php
                                                            $p_Id = (old('courier_id')?old('courier_id'):$ro->courier_id);
                                                        @endphp
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input readonly type="text" class="form-control @error('shipto_name') is-invalid @enderror"
                                                        ...
                                                        value="@if (old('shipto_name')){{ old('shipto_name') }}@else{{ (!is_null($ro->branch)?$ro->branch->name:'') }}@endif">
                                                    @error('shipto_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control @error('gross_weight') is-invalid @enderror" onkeyup="formatAmount($(this));"
                                                        ...
                                                        value="@if (old('gross_weight')){{ old('gross_weight') }}@else{{ !is_null($ro->gross_weight)?number_format($ro->gross_weight,0,'.',','):'' }}@endif">
                                                    @error('gross_weight')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control @error('measurement') is-invalid @enderror" maxlength="255" id="measurement" name="measurement" 
                                                        ...
                                                        value="@if (old('measurement')){{ old('measurement') }}@else{{ !is_null($ro->measurement)?number_format($ro->measurement,0,'.',','):'' }}@endif">
                                                    @error('measurement')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="remark" id="remark" rows="3" class="form-control @error('remark') is-invalid @enderror"
                                                        style="width: 100%;">@if (old('remark')){{ old('remark') }}@else{{ $ro->remark }}@endif</textarea>
                                                    @error('remark')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <tbody id="new-row">
                                            ...
                                            @if (old('part_id'.$lastIdx))
                                                <tr id="row{{ $lastIdx }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="ro_part_id{{ $lastIdx }}" id="ro_part_id{{ $lastIdx }}" value="{{ old('ro_part_id'.$lastIdx) }}">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td style="text-align: right;">
                                                        ...
                                                        <label for="" name="price_fob{{ $lastIdx }}" id="price_fob{{ $lastIdx }}"
                                                            class="col-form-label">{{ number_format(old('price_fob_val'.$lastIdx),($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                                    </td>
                                                    <td style="text-align: right;">
                                                        <label for="" name="total_fob{{ $lastIdx }}" id="total_fob{{ $lastIdx }}"
                                                            class="col-form-label">{{ number_format(old('qty'.$lastIdx)*old('price_fob_val'.$lastIdx),($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                                    </td>
                                                    <td style="text-align: right;">
                                    ...
                                    @else
                                        ...
                                        @foreach ($ro_part as $r_part)
                                            <tr id="row{{ $lastIdx }}">
                                                <td scope="row" style="text-align:right;">
                                                    <label for="" id="receipt_order_row_number{{ $lastIdx }}" class="col-form-label">{{ $lastIdx+1 }}</label>
                                                </td>
                                                <td>
                                                    @php
                                                    ...
                                                    <label for="" name="part_name{{ $lastIdx }}" id="part_name{{ $lastIdx }}"
                                                        class="col-form-label">{{ $partNumber.' : '.$qParts->part_name }}</label>
                                                    <input type="hidden" name="po_mo_no{{ $lastIdx }}" id="po_mo_no{{ $lastIdx }}" value="{{ $r_part->po_mo_no }}">
                                                    <input type="hidden" name="po_mo_id_{{ $lastIdx }}" id="po_mo_id_{{ $lastIdx }}" value="{{ $r_part->po_mo_id }}">
                                                    <input type="hidden" name="po_mo_part_id_{{ $lastIdx }}" id="po_mo_part_id_{{ $lastIdx }}" 
                                                        value="{{ $r_part->po_mo_part_id==null?0:$r_part->po_mo_part_id }}">
                                                    <input type="hidden" name="part_id{{ $lastIdx }}" id="part_id{{ $lastIdx }}" value="{{ $r_part->part_id }}">
                                                    <input type="hidden" name="ro_part_id{{ $lastIdx }}" id="ro_part_id{{ $lastIdx }}" value="{{ $r_part->id }}">
                                                </td>
                                                <td>
                                                    <input onchange="calcGrandTotal();" type="text" name="qty{{ $lastIdx }}" id="qty{{ $lastIdx }}"
                                                        class="form-control @error('qty'.$lastIdx) is-invalid @enderror" style="text-align: right;width: 100%;"
                                                        value="{{ $r_part->qty }}">
                                                    <input type="hidden" name="qty_on_po{{ $lastIdx }}" id="qty_on_po{{ $lastIdx }}" value="{{ $r_part->qty_on_po }}">
                                                    @error('qty'.$lastIdx)
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                @if ($qSupplier->supplier_type_id==10)
                                                    {{-- international --}}
                                                    @php
                                                        $exc_rate = $ro->exchange_rate==0 || $ro->exchange_rate==null? 0:$ro->exchange_rate;
                                                        $vat_import = $ro->total_vat_rp==0 || $ro->total_vat_rp==null? 0:$ro->total_vat_rp;
                                                        // $exch_rate_for_vat = $ro->exc_rate_for_vat==0 || $ro->exc_rate_for_vat==null? 0:$ro->exc_rate_for_vat;
                                                ...
                                                @endif
                                                <td style="text-align: right;">
                                                    <input type="hidden" name="price_fob_val{{ $lastIdx }}" id="price_fob_val{{ $lastIdx }}" value="{{ $r_part->final_fob }}">
                                                    <label for="" name="price_fob{{ $lastIdx }}" id="price_fob{{ $lastIdx }}"
                                                        class="col-form-label">{{ ($ro->supplier->supplier_type_id==10?$ro->currency->string_val:'').number_format($r_part->final_fob,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                                </td>
                                                <td style="text-align: right;">
                                                    <label for="" name="total_fob{{ $lastIdx }}" id="total_fob{{ $lastIdx }}"
                                                        class="col-form-label">{{ ($ro->supplier->supplier_type_id==10?$ro->currency->string_val:'').number_format($r_part->qty*$r_part->final_fob,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                                </td>
                                                <td style="text-align: right;">
                                                    <input type="hidden" name="price_local_val{{ $lastIdx }}" id="price_local_val{{ $lastIdx }}" value="{{ $r_part->final_cost }}">
                                                    <label for="" name="price_local{{ $lastIdx }}" id="price_local{{ $lastIdx }}" class="col-form-label">{{ $price_local }}</label>
                                                </td>
                                                <td style="text-align: right;">
                                                    <label for="" name="total{{ $lastIdx }}" id="total{{ $lastIdx }}" class="col-form-label">{{ $total }}</label>
                                    ...
                                    <tr id="rowTotal">
                                        ...
                                        <td style="text-align: right;">
                                            <label for="" name="lblTotalFOBAmount" id="lblTotalFOBAmount" class="col-form-label">
                                                {{ ($ro->supplier->supplier_type_id==10?$ro->currency->string_val:'').
                                                    number_format($lastTotalFobAmount,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="text-align: right;">
                                    ...
                                    {{-- <tr id="rowBeaMasuk">
                                        ...
                                        <td style="text-align: right;">
                                            <label for="" name="lblBeaMasukFOBAmount" id="lblBeaMasukFOBAmount"
                                                class="col-form-label">{{ ($ro->supplier->supplier_type_id==10?$ro->currency->string_val:'').number_format(($bea_masuk>0?$bea_masuk/$exc_rate:0),($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="text-align: right;">
                                    ...
                                    <tr id="rowVAT">
                                        ...
                                        <td style="text-align: right;">
                                            <label for="" name="lblVATAmount" id="lblVATAmount" class="col-form-label">
                                                @if ($qSupplier->supplier_type_id==10)
                                                    {{ (old('last_is_vat')=='Y'?number_format($vat_import,0,'.',','):
                                                        number_format(($last_is_vat=='Y'?$ro->total_vat_rp:0),0,'.',',')) }}
                                                    {{-- {{ (old('last_is_vat')=='Y'?number_format(((($lastTotalFobAmount+$import_shipping_cost)*$exch_rate_for_vat)+$bea_masuk)*$vat/100,0,'.',','):
                                                        number_format(($last_is_vat=='Y'?$ro->total_vat_rp:0),0,'.',',')) }} --}}
                                                @endif
                                                @if ($qSupplier->supplier_type_id==11)
                                                    {{ (old('last_is_vat')=='Y'?number_format($lastTotalAmount*$vat/100,0,'.',','):
                                                        number_format(($last_is_vat=='Y'?($lastTotalAmount*$vat/100):0),0,'.',',')) }}
                                                @endif
                                            </label>
                                        </td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr id="rowGrandTotal">
                                        ...
                                        <td style="text-align: right;">
                                            <label for="" name="lblGrandTotalAmount" id="lblGrandTotalAmount" class="col-form-label">
                                                @if ($qSupplier->supplier_type_id==10)
                                                    {{ (old('last_is_vat')=='Y'?number_format($lastTotalAmount+$vat_import,0,'.',','):number_format($ro->total_after_vat_rp,0,'.',',')) }}
                                                    {{-- {{ (old('last_is_vat')=='Y'?number_format($lastTotalAmount+(((($lastTotalFobAmount+$import_shipping_cost)*$exch_rate_for_vat)+$bea_masuk)*$vat/100),0,'.',','):
                ...
                <input type="hidden" name="currency_fob_tmp" id="currency_fob_tmp" value="@if(old('currency_fob_tmp')){{ old('currency_fob_tmp') }}@else{{ !is_null($ro->currency)?$ro->currency->string_val:'' }}@endif">
            </form>
        </div>
        <!--end row-->
    </div>
...
<script>
    ...
    function calcGrandTotal(){
        ...
        let grandTotalAmount = totalAmount+vatAmount;
        // if (supplier_type_id==10){
    ...
    $(document).ready(function() {
        ...
        $("#rm_po_mo").click(function() {
            let po_mo_no = '';
            for (i = 0; i <= $("#totalRowPoMo").val(); i++) {
                console.log($("#rowPoMoCheck"+i).is(':checked'));
                    ...
                    if (totOrder > 0) {
                        ...
                        switch(supplier_type_id) {
                            ...
                            default:
                                ...
                                $("#vat_import").val('');
                                $("#vat_import").attr("readonly");
                                // $("#exch_rate_for_vat").val('');
                                // $("#exch_rate_for_vat").attr("readonly");
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (totOrder > 0) {
                            ...
                            for (let i = 0; i < totOrder; i++) {
                                ...
                                if(qty>0){
                                    ...
                                    if(s.supplier_type_id==10){
                                        ...
                                        $("#price_local"+(totalRow-1)).text(parseFloat(o[i].price*excRate).numberFormat(2,'.',','));
                                        $("#price_local_val"+(totalRow-1)).val(o[i].price*excRate);
                                        $("#total"+(totalRow-1)).text(parseFloat(qty*o[i].price*excRate).numberFormat(2,'.',','));
                            ...
                            let lastBeaMasukFOBAmount = parseFloat(beamasukAmount/excRate).numberFormat(0,'.',',');
                            let lastVAT = ($('#last_is_vat').val()=='Y'?parseFloat((TotalAmount+beamasukAmount)*{{ $vat }}/100).numberFormat(0,'.',','):0);
                            let lastVATFOB = ($('#last_is_vat').val()=='Y'?parseFloat((TotalFOBAmount+(beamasukAmount/excRate))*{{ $vat }}/100).numberFormat(0,'.',','):0);
                            let grandTotal = ((parseFloat(TotalAmount+beamasukAmount)+($('#last_is_vat').val()=='Y'?parseFloat((TotalAmount+beamasukAmount)*{{ $vat }}/100):0)).numberFormat(0,'.',','));
                            let grandTotalFOB = (parseFloat(TotalFOBAmount+(beamasukAmount/excRate))+($('#last_is_vat').val()=='Y'?parseFloat(TotalFOBAmount+(beamasukAmount/excRate)*{{ $vat }}/100):0)).numberFormat(0,'.',',');
                            if(s.supplier_type_id==10){
                                // internasional
                                $("#lastTotalAmountTmp").val(TotalFOBAmount);
                            ...
                            // let vHtmlBeaMasuk =
                            //     '<tr id="rowBeaMasuk">'+
                            //     '<td colspan="4" style="text-align: right;"><label for="" name="lblBeaMasuk" id="lblBeaMasuk" class="col-form-label">Bea Masuk Import</label></td>'+
                            //     '<td style="text-align: right;"><label for="" name="lblBeaMasukFOBAmount" id="lblBeaMasukFOBAmount" class="col-form-label">'+currency_fob+lastBeaMasukFOBAmount+'</label></td>'+
                            //     '<td>&nbsp;</td>'+
                            //     '<td style="text-align: right;"><label for="" name="lblBeaMasukAmount" id="lblBeaMasukAmount" class="col-form-label">'+parseFloat(beamasukAmount).numberFormat(0,'.',',')+'</label></td>'+
                            //     '<td>&nbsp;</td>'+
                            //     '</tr>';
                            // $("#new-row").append(vHtmlBeaMasuk);
                            let vHtmlVAT =
                                '<tr id="rowVAT">'+
