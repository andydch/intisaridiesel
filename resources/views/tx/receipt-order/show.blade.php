    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="submit-form" action="{{ url(ENV('TRANSACTION_FOLDER_NAME').'/'.$folder.'/'.$ro->id) }}" method="POST" enctype="application/x-www-form-urlencoded">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ $currencySymbol.number_format($ro->invoice_amount,($ro->supplier->supplier_type_id==10?2:0),'.',',') }}</label>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="exc_rate" class="col-sm-3 col-form-label">Exchange Rate</label>
                                                <label for="" class="col-sm-9 col-form-label">{{ $ro->exchange_rate>0?$qCurrency->string_val.number_format($ro->exchange_rate,2,'.',','):'' }}</label>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            {{-- <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ $ro->exc_rate_for_vat>0?$qCurrency->string_val.number_format($ro->exc_rate_for_vat,2,'.',','):'' }}</label>
                                            </div> --}}
                                            <div class="row mb-3">
                                                <label for="exc_rate" class="col-sm-3 col-form-label">Bea Masuk Import</label>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label for="" class="col-sm-9 col-form-label">{{ $ro->import_shipping_cost>0?$currencySymbol.number_format($ro->import_shipping_cost,2,'.',','):'' }}</label>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label for="weight_type_id02" class="col-sm-3 col-form-label">Journal Type</label>
                                                <label for="" class="col-sm-9 col-form-label">
                                                    <span style="font-weight: 700;">{{ $ro->journal_type_id }}</span>
                                                    @if ($ro->journal_type_id!=null)
                                                        <span style="color: red;font-weight:700;">{{ $ro->journal_type_id=='P'?'Akan Dibayar PPN?':'Akan Dibayar Non PPN?' }}</span>
                                                    @endif
                                                </label>
                                            </div>
                                        </div>
                ...
                <input type="hidden" name="currency_fob_tmp" id="currency_fob_tmp" value="{{ !is_null($ro->currency)?$ro->currency->string_val:'' }}">
            </form>
        </div>
        <!--end row-->
    </div>
