                        ...
                        <div class="col-xl-6">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row mb-3">
                                        <label for="month_id" class="col-sm-3 col-form-label">Month</label>
                                        <div class="col-sm-9">
                                            <select class="form-select single-select @error('month_id') is-invalid @enderror"
                                                id="month_id" name="month_id">
                                                @php
                                                    $month_id = (old('month_id')?old('month_id'):'');
                                                    $i = 0;
                                                @endphp
                                                @foreach (explode(",",$months) as $month)
                                                    <option @if($month_id==$i){{ 'selected' }}@endif
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select single-select @error('year_id') is-invalid @enderror"
                                                id="year_id" name="year_id">
                                                <option value="">Choose...</option>
                                                @php
                                                    $year_id = (old('year_id')?old('year_id'):'');
                                                    $i = 2025;
                                                @endphp
                                                @for ($i;$i<=$latest_year;$i++)
                                                    <option @if($year_id==$i){{ 'selected' }}@endif
                                                        value="{{ $i }}">{{ $i }}</option>
                                                @endfor
                                            </select>
                                            @error('year_id')
