                        ...
                        <table class="table table-striped table-bordered" id="inventory-per-merk-per-part-no" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>MERK</th>
                                    <th>GUDANG</th>
                                    <th>COST AMOUNT (Rp)</th>
                                    <th>SALES AMOUNT (Rp)</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php
                            ...
                            <tfoot>
                                <tr>
                                    <th>&nbsp;</th>
                                    <th>GRAND TOTAL</th>
                                    <th style="text-align: right;">{{ number_format($total_cost_amount,2,',','.') }}</th>
                                    <th style="text-align: right;">{{ number_format($total_sales_amount,2,',','.') }}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
