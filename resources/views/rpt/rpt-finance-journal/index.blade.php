                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="row mb-3">
                                        <label for="journal_no" class="col-sm-3 col-form-label">Journal No</label>
                                        <div class="col-sm-9">
                                            <select class="form-select single-select @error('journal_no') is-invalid @enderror"
                                                id="journal_no" name="journal_no">
                                                <option value="">Choose...</option>
                                                @foreach ($generalJournal as $j)
                                                    <option value="{{ $j->journal_no }}">{{ $j->journal_no }}</option>
                                                @endforeach
                                                @foreach ($lokalJournal as $j)
                                                    <option value="{{ $j->journal_no }}">{{ $j->journal_no }}</option>
                                                @endforeach
                                            </select>
                                            @error('journal_no')
