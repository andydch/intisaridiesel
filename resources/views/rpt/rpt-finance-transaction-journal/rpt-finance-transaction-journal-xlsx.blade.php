        ...
        <div class="table-responsive">
            <table style="width:1024px;">
                <thead>
                    ...
                    <tr>
                        <th colspan="7">TRANSACTION JOURNAL</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    @php
                        ...
                        $identity = '';
                        if ($lokal_input=='A' || $lokal_input=='x'){
                            $identity = 'All';
                        }
                        if ($lokal_input=='P'){
                            $identity = 'Tax';
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;border:1px solid black;background-color:#ff6600;">COA</td>
                        ...
                        <td style="text-align: center;border:1px solid black;background-color:#ff6600;">REMARKS</td>
                    </tr>
                            ...
                            @foreach ($allJd as $journal)
                                ...
                                <tr>
                                    @php
                                        $top_border = '';
                                    @endphp
                                    @if ($general_journal_date_tmp!=$journal->general_journal_date)
                                        @php
                                            $top_border = 'border-top:1px solid black;';
                                        @endphp
                                    @endif
                                    <td style="text-align: center;border-left:1px solid black;{!! $top_border !!}">{{ ($general_journal_date_tmp!=$journal->general_journal_date?date_format(date_create($journal->general_journal_date),"d-M-Y"):'') }}</td>
                                    <td style="text-align: center;{!! $top_border !!}">{{ ($general_journal_no_tmp!=$journal->general_journal_no?$journal->general_journal_no:'') }}</td>
                                    <td style="text-align: left;{!! $top_border !!}">{{ $journal->coa_code_complete }}</td>
                                    <td style="text-align: left;{!! $top_border !!}">{{ $journal->coa_name }}</td>
                                    <td style="text-align: right;{!! $top_border !!}">{{ $journal->debit }}</td>
                                    <td style="text-align: right;{!! $top_border !!}">{{ $journal->kredit }}</td>
                                    <td style="text-align: right;border-right:1px solid black;{!! $top_border !!}">{{ $journal->description }}</td>
                                    @php
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="4" style="border-left:1px solid black;border-top:1px solid black;border-bottom:1px solid black;text-align:right;font-weight:700;">TOTAL</td>
