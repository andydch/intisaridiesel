...
class DispSQcustSuratJalanController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        // $queryC = Tx_surat_jalan::leftJoin('userdetails AS usr','tx_surat_jalans.created_by','=','usr.user_id')
        // ->where('tx_surat_jalans.customer_id','=',$request->cid)
