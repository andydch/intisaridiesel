...
class ReportSalesActualVsTargetPerBranchController extends Controller
{
    protected $title = 'Sales Actual vs Target Per Branch';
    protected $folder = 'sales-actual-vs-target-per-branch';
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            return redirect(ENV('REPORT_FOLDER_NAME').'/'.$this->folder.'-xlsx/'.$request->period_year);
        }
    }
