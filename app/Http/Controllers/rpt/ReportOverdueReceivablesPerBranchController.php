...
class ReportOverdueReceivablesPerBranchController extends Controller
{
    protected $title = 'Overdue Receivables Per Branch';
    protected $folder = 'overdue-receivables-per-branch';
