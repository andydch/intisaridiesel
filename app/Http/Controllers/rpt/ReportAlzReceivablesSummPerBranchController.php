...
class ReportAlzReceivablesSummPerBranchController extends Controller
{
    protected $title = 'Summary Analisa Piutang Per Cabang';
    protected $folder = 'analyze-receivables-summary-per-branch';
