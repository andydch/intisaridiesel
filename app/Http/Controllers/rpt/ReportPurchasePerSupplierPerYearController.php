...
class ReportPurchasePerSupplierPerYearController extends Controller
{
    protected $title = 'Purchase Per Supplier Per Year';
    protected $folder = 'purchase-per-supplier-per-year';
