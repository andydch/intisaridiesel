...
class ReportPurchaseSupplierPaymentStatus02Controller extends Controller
{
    protected $title = 'Supplier Payment Status';
    protected $folder = 'purchase-supplier-payment-status-02';
