...
class ReportSalesTargetCustomerPerBranchController extends Controller
{
    protected $title = 'Sales Target Customer Per Branch';
    protected $folder = 'sales-target-customer-per-branch';
