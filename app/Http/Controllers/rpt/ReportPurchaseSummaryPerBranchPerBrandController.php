...
class ReportPurchaseSummaryPerBranchPerBrandController extends Controller
{
    protected $title = 'Purchase Summary Per Branch Per Brand';
    protected $folder = 'purchase-summary-per-branch-per-brand';
