...
class ReportInventoryOverStockUnderStockController extends Controller
{
    protected $title = 'Inventory Over Stock / Under Stock';
    protected $folder = 'inventory-over-stock-under-stock';
