...
class ReportOutstandingPurchaseOrderController extends Controller
{
    protected $title = 'Outstanding Purchase Order Per P/N';
    protected $folder = 'outstanding-purchase-order';
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            return redirect(ENV('REPORT_FOLDER_NAME').'/outstanding-purchase-order-per-pn-xlsx/'.$request->branch_id.'/'.$request->year_id);
        }
    }
