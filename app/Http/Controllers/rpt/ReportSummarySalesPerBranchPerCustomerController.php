...
class ReportSummarySalesPerBranchPerCustomerController extends Controller
{
    protected $title = 'Summary Sales Per Branch Per Customer';
    protected $folder = 'summary-sales-per-branch-per-customer';
