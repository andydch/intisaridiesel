...
class ReportPenjualanPerCustomerPerPartsNoSoSjController extends Controller
{
    protected $title = 'Penjualan Per Customer Per Parts No (SO & SJ)';
    protected $folder = 'penjualan-per-customer-per-parts-no-so-sj';
