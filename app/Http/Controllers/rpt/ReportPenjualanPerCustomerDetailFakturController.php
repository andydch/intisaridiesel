...
class ReportPenjualanPerCustomerDetailFakturController extends Controller
{
    protected $title = 'Sales Per Customer Detail Faktur';
    protected $folder = 'penjualan-per-customer-detail-faktur';
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            return redirect(ENV('REPORT_FOLDER_NAME').'/'.$this->folder.'-xlsx/'.$request->customer_id.'/'.$request->date_start.'/'.$request->date_end);
        }
    }
