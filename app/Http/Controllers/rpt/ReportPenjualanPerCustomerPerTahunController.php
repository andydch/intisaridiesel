...
class ReportPenjualanPerCustomerPerTahunController extends Controller
{
    protected $title = 'Penjualan Per Customer Per Tahun';
    protected $folder = 'penjualan-per-customer-per-tahun';
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            return redirect(ENV('REPORT_FOLDER_NAME').'/'.$this->folder.'-xlsx/'.$request->date_start.'/'.$request->date_end.'/'.$request->lokal_input);
        }
    }
