...
class ReportInventoryPerGudangPerPartNoController extends Controller
{
    protected $title = 'Inventory Per Gudang Per Part No';
    protected $folder = 'inventory-per-gudang-per-part-no';
