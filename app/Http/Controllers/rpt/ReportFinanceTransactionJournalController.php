...
class ReportFinanceTransactionJournalController extends Controller
{
    protected $title = 'Transaction Journal';
    protected $folder = 'rpt-finance-transaction-journal';
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            ...
            return redirect(ENV('REPORT_FOLDER_NAME').'/'.$this->folder.'-xlsx/'.$lokal_input.'/'.$branch_id.'/'.urlencode($request->date_start).'/'.urlencode($request->date_end));
        }
    }
