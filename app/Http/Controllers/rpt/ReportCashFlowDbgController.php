...
class ReportCashFlowDbgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(ENV('REPORT_FOLDER_NAME').'.'.$this->folder.'.index-dbg', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->view_mode=='P'){
            return redirect(ENV('REPORT_FOLDER_NAME').'/rpt-'.$this->folder.'-xlsx-dbg/'.urlencode($request->period_month.'-'.$request->period_year).'/'.$request->bank_id);
        }
    }
