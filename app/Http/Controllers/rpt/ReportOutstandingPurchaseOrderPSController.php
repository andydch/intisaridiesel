...
class ReportOutstandingPurchaseOrderPSController extends Controller
{
    protected $title = 'Oustanding Purchase Order';
    protected $folder = 'outstanding-purchase-order-ps';
