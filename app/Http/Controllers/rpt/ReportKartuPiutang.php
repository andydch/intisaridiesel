...
class ReportKartuPiutang extends Controller
{
    protected $title;
    protected $folder = 'rpt-finance-kartu-piutang';

    public function __construct()
    {
        $this->title = ucwords(strtolower(ENV('KARTU_PIUTANG')));
    }
