...
class QuotationServerSideDbgController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            ->addColumn('tx_quotation_date', function ($query) {
            ...
            ->addColumn('action', function ($query) {
                ...
                if(($query->created_by==Auth::user()->id || $userLogin->is_director=='Y' || $userLogin->is_branch_head=='Y') && $query->quotation_active=='Y'){
                    if(strpos($query->quotation_no,"Draft")==0){
            ...
            ->rawColumns(['tx_quotation_date','action','status'])
            ->toJson();
        }
    ...
    public function create()
    {
        ...
        return view('tx.'.$this->folder.'.create-dbg', $data);
    }
