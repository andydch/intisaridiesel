...
{
    protected $title = 'Employee Section';
    protected $dataCat = 'employee-section';
    ...
    public function index()
    {
        ...
        return view('adm.global.employee-section-index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('adm.global.employee-section-create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), [
            ...
            'title_ind.required' => 'Employee Section is required',
            'value_string.required' => 'Currency Symbol is required'
        ])->validate();
    ...
    public function show($slug)
    {
        ...
        return view('adm.global.employee-section-show', $data);
    }
    ...
    public function edit($slug)
    {
        ...
        return view('adm.global.employee-section-edit', $data);
    }
