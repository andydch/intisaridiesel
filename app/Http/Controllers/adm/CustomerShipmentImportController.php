...
use App\Imports\admin\CustomerShipmentImport;

class CustomerShipmentImportController extends Controller
{
    /**
    ...
    public function __invoke(Request $request)
    {
        ...
        try {
            Excel::import(new CustomerShipmentImport, $realpath . $xlsNm);
        ...
        return redirect(env('ADMIN_FOLDER_NAME') . '/customer-shipment-address');
    }
}
