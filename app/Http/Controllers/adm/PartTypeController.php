...
{
    protected $title = 'Part Type';
    protected $dataCat = 'part-type';
    ...
    public function index()
    {
        ...
        return view('adm.global.part-type-index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('adm.global.part-type-create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), [
            ...
            // 'title_ind' => 'required|max:512|unique:\App\Models\Mst_global,title_ind',
            // 'value_string' => 'max:32|required',
        ], [
            'title_ind.required' => $this->title.' Name is required',
            'title_ind.unique' => $this->title.' Name must be unique',
    ...
    public function show($slug)
    {
        ...
        return view('adm.global.part-type-show', $data);
    }
    ...
    public function edit($slug)
    {
        ...
        return view('adm.global.part-type-edit', $data);
    }
