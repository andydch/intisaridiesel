...
class ReportFinanceTransactionPerAccountExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $coa_id;
    protected $date_start;
    protected $date_end;

    public function __construct($coa_id,$date_start,$date_end)
    {
        // ini_set('memory_limit', '64M');
        // ini_set('max_execution_time', 1800);

        $this->coa_id = urldecode($coa_id);
    ...
    public function view(): View
    {
        ...
        return view('rpt.rpt-finance-transaction-per-account.rpt-finance-transaction-per-account-xlsx',$data);
    }
