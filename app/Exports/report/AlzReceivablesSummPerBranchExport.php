...
class AlzReceivablesSummPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.analyze-receivables-summary-per-branch.analyze-receivables-summary-per-branch-xlsx',$data);
    }
