...
class InventoryOverStockUnderStockExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.inventory-over-stock-under-stock.inventory-over-under-stock-xls',$data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // $sheet->getStyle('A6:M7')->getFill()->applyFromArray([
        //     'fillType' => 'solid',
        //     'rotation' => 0,
        //     'color' => ['rgb' => 'eaf1dd'],
        // ]);
        ...
        // set tanggal center
        // $sheet->getStyle('M5')->applyFromArray($styleArray);

        // $sheet->getStyle('A6:M'.$lastHighestRow)->applyFromArray([
        //     'borders' => [
        //         'allBorders' => [
