...
class ReportSalesTargetPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-target-per-branch.sales-target-per-branch-xlsx',$data);
    }
