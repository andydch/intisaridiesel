...
class ReportSalesPerFakturPerSalesOrderExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-per-faktur-per-sales-order.sales-per-faktur-per-sales-order-xlsx',$data);
    }
