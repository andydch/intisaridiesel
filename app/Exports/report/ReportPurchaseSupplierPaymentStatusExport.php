...
class ReportPurchaseSupplierPaymentStatusExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-supplier-payment-status.purchase-supplier-payment-status-xlsx',$data);
    }
