...
class SalesPerBranchPerCustomerExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function __construct($branch_id,$date_start,$date_end,$lokal_input,$customer_id)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-per-branch-per-customer.sales-per-branch-per-customer-xlsx',$data);
    }
