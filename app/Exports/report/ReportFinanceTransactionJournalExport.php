...
class ReportFinanceTransactionJournalExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function __construct($lokal_input,$branch_id,$date_start,$date_end)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.rpt-finance-transaction-journal.rpt-finance-transaction-journal-xlsx',$data);
    }
