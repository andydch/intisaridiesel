...
class ReportSalesTargetCustomerPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-target-customer-per-branch.sales-target-customer-per-branch-xlsx',$data);
    }
