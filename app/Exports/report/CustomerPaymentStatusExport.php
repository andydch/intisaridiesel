...
class CustomerPaymentStatusExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.customer-payment-status.customer-payment-status-xlsx',$data);
    }
