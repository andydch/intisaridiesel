...
class ReportPenjualanPerCustomerPerPartsNoExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.penjualan-per-customer-per-parts-no.penjualan-per-customer-per-parts-no-xlsx',$data);
    }
