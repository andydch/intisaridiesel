...
class ReportPurchaseSupplierPaymentStatus02Export implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-supplier-payment-status-02.purchase-supplier-payment-status-02-xlsx',$data);
    }
