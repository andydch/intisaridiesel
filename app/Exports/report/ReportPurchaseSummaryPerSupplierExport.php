...
class ReportPurchaseSummaryPerSupplierExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function __construct($branch_id, $date_start, $date_end, $lokal_input)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-summary-per-supplier.purchase-summary-per-supplier-xlsx',$data);
    }
