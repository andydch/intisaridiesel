...
class InventoryPerMerkPerPartNoExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    ...
    public function headings(): array
    {
        ...
        ->first();
        if($brands){
            $brand = $brands->title_ind;
        }
        return [
            ['REPORT INVENTORY PER MERK per PARTS NO'],
            ['MERK: '.$brand],
            [
                "PARTS NO",
                "DESCRIPTION",
