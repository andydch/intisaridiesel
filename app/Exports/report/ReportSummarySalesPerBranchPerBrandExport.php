...
class ReportSummarySalesPerBranchPerBrandExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.summary-penjualan-per-branch-per-brand.summary-penjualan-per-branch-per-brand-xlsx',$data);
    }
