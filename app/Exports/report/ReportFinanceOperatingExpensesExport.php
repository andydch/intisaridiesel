...
class ReportFinanceOperatingExpensesExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.rpt-finance-operating-expenses.rpt-finance-operating-expenses-xlsx',$data);
    }
