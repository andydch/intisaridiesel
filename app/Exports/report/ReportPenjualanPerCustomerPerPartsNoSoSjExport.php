...
class ReportPenjualanPerCustomerPerPartsNoSoSjExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function __construct($customer_id,$date_start,$date_end,$lokal_input)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.penjualan-per-customer-per-parts-no-so-sj.penjualan-per-customer-per-parts-no-so-sj-xlsx',$data);
    }
