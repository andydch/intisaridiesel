...
class ReportPurchasePerSupplierPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-per-supplier-per-cabang.purchase-per-supplier-per-cabang-xlsx',$data);
    }
