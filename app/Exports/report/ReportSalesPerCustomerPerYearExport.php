...
class ReportSalesPerCustomerPerYearExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $period_year;
    protected $lokal_input;

    public function __construct($period_year,$lokal_input)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-per-cust-per-year.sales-per-cust-per-year-xlsx',$data);
    }
