...
class ReportSummarySalesPerBranchPerCustomerExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.summary-sales-per-branch-per-customer.summary-sales-per-branch-per-customer-xlsx',$data);
    }
