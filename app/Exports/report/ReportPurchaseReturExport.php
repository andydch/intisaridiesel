...
class ReportPurchaseReturExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-retur-rpt.purchase-retur-rpt-xlsx',$data);
    }
