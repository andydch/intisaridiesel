...
class StockInventoryAccPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    protected $year_id;
    ...
    public function view(): View
    {
        ...
        return view('rpt.stock-inventory-accuration-per-branch.stock-inventory-accuration-per-branch-xlsx',$data);
    }
