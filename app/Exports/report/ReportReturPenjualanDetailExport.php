...
class ReportReturPenjualanDetailExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $lokal_input;
    protected $date_start;
    protected $date_end;

    public function __construct($lokal_input,$date_start,$date_end)
    {
    ...
    public function view(): View
    {
        ...
        $data = [
            'lokal_input' => ($this->lokal_input==''?'x':$this->lokal_input),
        ...
        return view('rpt.retur-penjualan-detail.retur-penjualan-detail-xlsx',$data);
    }
