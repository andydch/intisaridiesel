...
class ReportSummarySalesPerBranchPerSalesmanExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $date_start;
    protected $date_end;
    protected $lokal_input;

    public function __construct($date_start,$date_end,$lokal_input)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.summary-sales-per-branch-per-salesman.summary-sales-per-branch-per-salesman-xlsx',$data);
    }
