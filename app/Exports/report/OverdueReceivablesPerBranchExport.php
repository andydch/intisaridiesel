...
class OverdueReceivablesPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $branch_id;
    protected $lokal_input;

    public function __construct($branch_id,$lokal_input)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.overdue-receivables-per-branch.overdue-receivables-per-branch-xlsx',$data);
    }
