...
class ReportPurchasePerSupplierPerYearExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-per-supplier-per-year.purchase-per-supplier-per-year-xlsx',$data);
    }
