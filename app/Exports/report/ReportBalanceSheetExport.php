...
class ReportBalanceSheetExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.balance-sheet.balance-sheet-xlsx',$data);
    }
