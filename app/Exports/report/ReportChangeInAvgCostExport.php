...
class ReportChangeInAvgCostExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view(ENV('REPORT_FOLDER_NAME').'.'.$this->folder.'.report-avg-cost-change-xlsx', $data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A6:L6')->getFill()->applyFromArray([
            'fillType' => 'solid',
            'rotation' => 0,
            'color' => ['rgb' => 'eaf1dd'],
        ]);
        ...
        $sheet->getStyle('A6:L'.$lastHighestRow)->applyFromArray([
            'borders' => [
                'allBorders' => [
