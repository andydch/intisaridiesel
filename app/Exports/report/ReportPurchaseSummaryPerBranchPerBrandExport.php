...
class ReportPurchaseSummaryPerBranchPerBrandExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view('rpt.purchase-summary-per-branch-per-brand.purchase-summary-per-branch-per-brand-xlsx',$data);
    }
