...
class ReportSalesActualVsTargetPerBranchExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $period_year;

    public function __construct($period_year)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.sales-actual-vs-target-per-branch.sales-actual-vs-target-per-branch-xlsx',$data);
    }
