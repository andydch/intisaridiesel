...
class ReportPenjualanPerCustomerDetailFakturExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    protected $cust_id;
    protected $date_start;
    protected $date_end;

    public function __construct($cust_id,$date_start,$date_end)
    {
    ...
    public function view(): View
    {
        ...
        return view('rpt.penjualan-per-customer-detail-faktur.penjualan-per-customer-detail-faktur-xlsx',$data);
    }
