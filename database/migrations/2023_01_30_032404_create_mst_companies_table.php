...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mst_companies', function (Blueprint $table) {
            $table->id();
            $table->string('name', 255)->comment('nama company');
            ...
            $table->unsignedBigInteger('npwp_province_id')->nullable();
            $table->unsignedBigInteger('npwp_city_id')->nullable();
            $table->unsignedBigInteger('npwp_district_id')->nullable();
            $table->unsignedBigInteger('npwp_sub_district_id')->nullable();
