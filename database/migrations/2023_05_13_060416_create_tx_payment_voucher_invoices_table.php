...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tx_payment_voucher_invoices', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('payment_voucher_id')->comment('FK ke table tx_payment_vouchers');
    ...
    {
        Schema::dropIfExists('tx_payment_voucher_invoices');
    }
};
