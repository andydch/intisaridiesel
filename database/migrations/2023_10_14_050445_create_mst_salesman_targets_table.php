...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mst_salesman_targets', function (Blueprint $table) {
            $table->id();
            $table->integer('year')->comment('tahun dari sales target');
            $table->unsignedBigInteger('branch_id')->comment('FK ke mst_branches');
            $table->decimal('sales_target',20,2)->comment('total target sales per tahun');
    ...
    {
        Schema::dropIfExists('mst_salesman_targets');
    }
};
