...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mst_company_bank_information', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_id')->comment('FK ke master company');
    ...
    {
        Schema::dropIfExists('mst_company_bank_information');
    }
};
