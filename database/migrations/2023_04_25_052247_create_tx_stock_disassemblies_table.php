...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tx_stock_disassemblies', function (Blueprint $table) {
            $table->id();
            $table->string('stock_disassembly_no', 15);
            $table->date('stock_disassembly_date');
    ...
    {
        Schema::dropIfExists('tx_stock_disassemblies');
    }
};
